export const dict = {
  ...
  "error.page.report.link": "قناة الدعم",
  ...
  "app.name": "RAILWISE",
  "settings.section.application": "التطبيق",
  "settings.section.server": "الخادم",
  "settings.tab.general": "عام",
  "settings.tab.shortcuts": "اختصارات",
  "settings.platform.section.wsl": "WSL",
  "settings.platform.wsl.title": "تكامل WSL",
  "settings.platform.wsl.description": "تشغيل خادم RAILWISE داخل WSL على Windows.",
