export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju RAILWISE-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} RAILWISE-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "RAILWISE Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka RAILWISE CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
