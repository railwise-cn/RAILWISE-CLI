...
Placez votre configuration globale RAILWISE dans `~/.config/railwise/railwise.json`. Utilisez la configuration globale pour les préférences de l'utilisateur telles que les thèmes, les fournisseurs ou les raccourcis clavier.
...
Vous pouvez configurer le thème que vous souhaitez utiliser dans votre configuration RAILWISE via l'option `theme`.
