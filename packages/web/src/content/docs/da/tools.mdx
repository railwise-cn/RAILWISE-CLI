...
Her er alle de innebygde verktøyene som er tilgængelige i RAILWISE.
...
:::note
Dette verktøyet er bare tilgængelig når du bruger RAILWISE-leverandøren eller når miljøvariabelen `RAILWISE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
