...
export const dict = {
  ...
  "dialog.provider.railwise.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.railwise.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.railwiseGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av RAILWISE",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i RAILWISE.",
  ...
  "provider.connect.railwiseZen.line1":
    "RAILWISE Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.railwiseZen.visit.prefix": "Besøk ",
  "provider.connect.railwiseZen.visit.link": "railwise.ai/zen",
  "provider.connect.railwiseZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i RAILWISE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i RAILWISE.",
  ...
  "dialog.server.description": "Bytt hvilken RAILWISE-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av RAILWISE ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til RAILWISE-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at RAILWISE ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "RAILWISE inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør RAILWISE-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for RAILWISE",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan RAILWISE ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om RAILWISE skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan RAILWISE er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når RAILWISE starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av RAILWISE.",
