export const dict = {
  ...
  "dialog.provider.railwise.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by RAILWISE",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in RAILWISE.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.railwiseZen.line1":
    "RAILWISE Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.railwiseZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.railwiseZen.visit.prefix": "Visit ",
  "provider.connect.railwiseZen.visit.link": "railwise.ai/zen",
  "provider.connect.railwiseZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in RAILWISE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in RAILWISE.",
  ...
  "dialog.server.description": "Switch which RAILWISE server this app connects to.",
  ...
  "toast.update.description": "A new version of RAILWISE ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the RAILWISE team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, RAILWISE does not support MCP authentication yet.',
  ...
  "session.side.agent": "Collaboration",
  "session.side.model": "Model",
  "session.side.progress": "Session",
  "session.side.context": "Context",
  "session.side.project.empty": "Untitled",
  "session.side.agent.empty": "Unassigned",
  "session.side.model.empty": "No model",
  "session.side.progress.ready": "Ready",
  "session.side.progress.loading": "Loading",
  "session.side.progress.waiting": "Waiting",
  "session.side.progress.turns": "{{count}} turns",
  "session.side.context.pending": "Open a session",
  "session.side.context.empty": "No usage",
  "session.side.context.percent": "{{percent}}%",
  "session.side.runtime.title": "Execution",
  "session.side.runtime.blockers": "Needs action",
  "session.side.runtime.blockers.ready": "Ready",
  "session.side.runtime.blockers.none": "None",
  "session.side.runtime.blockers.pending": "{{count}} pending",
  "session.side.runtime.todos": "Todos",
  "session.side.runtime.todos.ready": "Ready",
  "session.side.runtime.todos.empty": "None",
  "session.side.runtime.todos.progress": "{{done}}/{{total}} done",
  "session.side.runtime.capabilities": "Capabilities",
  "session.side.runtime.capabilities.ready": "Ready",
  "session.side.runtime.capabilities.empty": "None",
  "session.side.runtime.capabilities.count": "{{count}} capabilities",
  "session.side.runtime.tools": "Tools",
  "session.side.runtime.tools.empty": "No calls",
  "session.side.runtime.tools.running": "{{count}} running",
  "session.side.runtime.tools.error": "{{count}} errors",
  "session.side.runtime.tools.done": "{{done}}/{{total}} done",
  "session.side.runtime.tool.pending": "Pending",
  "session.side.runtime.tool.running": "Running",
  "session.side.runtime.tool.completed": "Done",
  "session.side.runtime.tool.error": "Error",
  "session.side.runtime.tool.runningSummary": "The tool is running and waiting for results.",
  "session.side.runtime.state.ready": "Ready",
  "session.side.runtime.state.loading": "Loading",
  "session.side.runtime.state.busy": "Running",
  ...
  "session.side.runtime.chain.title": "Execution path",
  "session.side.runtime.chain.model": "Model",
  "session.side.runtime.chain.agent": "Collaboration",
  "session.side.runtime.chain.capabilities": "Capabilities",
  "session.side.runtime.chain.tools": "Tools",
  "session.side.runtime.chain.next": "Next",
  "session.side.runtime.chain.next.ready": "Ready to start",
  "session.side.runtime.chain.next.waiting": "Waiting for the next turn",
  "session.side.runtime.chain.status.done": "Ready",
  "session.side.runtime.chain.status.running": "Running",
  "session.side.runtime.chain.status.blocked": "Needs action",
  "session.side.runtime.chain.status.waiting": "Waiting",
  "session.side.runtime.chain.status.error": "Error",
  "session.side.runtime.chain.action.connectModel": "Connect",
  "session.side.runtime.chain.action.switchModel": "Switch",
  "session.side.runtime.chain.action.configure": "Configure",
  "session.side.runtime.chain.action.view": "View",
  "session.side.runtime.chain.action.repair": "Repair",
  "session.side.runtime.chain.action.handle": "Handle",
  "session.side.runtime.chain.action.focus": "Focus",
  "session.side.runtime.chain.action.input": "Input",
  "session.execution.title": "Execution evidence",
  "session.execution.agent.empty": "No agent",
  "session.execution.agent.more": "{{agents}} and {{count}} more",
  "session.execution.capabilities": "Capabilities",
  ...
  "session.execution.tool.pending": "Pending",
  "session.execution.tool.running": "Running",
  "session.execution.tool.completed": "Done",
  "session.execution.tool.error": "Error",
  "session.execution.tool.runningSummary": "The tool is running and waiting for results.",
  ...
  "sidebar.gettingStarted.line1": "RAILWISE includes free models so you can start immediately.",
  ...
  "settings.general.section.privacy": "Privacy",

  "settings.general.row.language.title": "Language",
  "settings.general.row.language.description": "Change the display language for RAILWISE",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how RAILWISE looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how RAILWISE is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when RAILWISE launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of RAILWISE.",
  "settings.privacy.telemetry.title": "Usage statistics",
  "settings.privacy.telemetry.description":
    "Share anonymous UI counts and crash reports. Prompt content, project names, and file paths are never stored.",
  "telemetry.consent.title": "Help improve RAILWISE",
  "telemetry.consent.description":
    "Share anonymous UI counts and crash reports. Prompt content, project names, file names, and file paths stay off telemetry. You can change this later in Settings.",
  "telemetry.consent.accept": "Share statistics",
  "telemetry.consent.decline": "Not now",
  ...
  "settings.providers.description": "Connect, disconnect, and review model providers.",
  ...
  "settings.models.description": "Review available models and current defaults.",
  "settings.agents.title": "Agents",
  "settings.agents.description": "Review agents, hot-reload sources, and recent calls.",
  "settings.commands.title": "Commands",
  "settings.commands.description": "Review commands, shortcuts, and project slash commands.",
  "settings.mcp.title": "MCP",
  "settings.mcp.description": "Review and toggle MCP server connections.",
