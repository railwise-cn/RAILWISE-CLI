...
Ajan becerileri, yonsoon'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
yonsoon su konumlari tarar:

- Proje konfigurasyonu: `.yonsoon/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/yonsoon/skills/<name>/SKILL.md`
...
Proje yerel yollarinda yonsoon, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.yonsoon/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/yonsoon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.yonsoon/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
yonsoon, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`yonsoon.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`yonsoon.json` icinde):
