export const dict = {
  ...
  "dialog.provider.yonsoon.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo YONSOON (甬算)",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no YONSOON (甬算).",
  ...
  "provider.connect.yonsoonZen.line1":
    "YONSOON (甬算) Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.yonsoonZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.yonsoonZen.visit.prefix": "Visite ",
  "provider.connect.yonsoonZen.visit.link": "yonsoon.ai/zen",
  "provider.connect.yonsoonZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no YONSOON (甬算).",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no YONSOON (甬算).",
  ...
  "dialog.plugins.empty": "Plugins configurados em yonsoon.json",
  ...
  "dialog.server.description": "Trocar para qual servidor YONSOON (甬算) este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do YONSOON (甬算) ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do YONSOON (甬算)",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (yonsoon.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: YONSOON (甬算) ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "YONSOON (甬算) inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor YONSOON (甬算) dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do YONSOON (甬算)",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o YONSOON (甬算) aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o YONSOON (甬算) é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o YONSOON (甬算) iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do YONSOON (甬算).",
