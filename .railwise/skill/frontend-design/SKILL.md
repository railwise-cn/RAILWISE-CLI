...
```html
正常：background: #dcfce7; color: #166534; border-radius: 4px; padding: 2px 8px; 提示：background: #fef9c3; color:
#854d0e; 预警：background: #ffedd5; color: #9a3412; 报警：background: #fee2e2; color: #991b1b; font-weight: 600;
```
