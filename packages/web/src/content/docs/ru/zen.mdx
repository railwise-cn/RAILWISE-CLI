...
:::note
RAILWISE Zen сейчас находится в бета-версии.
:::
...
- MiniMax M2.5 Free доступна в RAILWISE ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Ring 2.6 1T Free доступна в RAILWISE ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- Nemotron 3 Super Free доступна в RAILWISE ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
...
- Ring 2.6 1T Free: во время бесплатного периода собранные данные могут использоваться для улучшения модели.
