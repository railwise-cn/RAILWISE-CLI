export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من YONSOON (甬算)",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من YONSOON (甬算)، هل ترغب في تثبيته وإعادة تشغيله؟",
