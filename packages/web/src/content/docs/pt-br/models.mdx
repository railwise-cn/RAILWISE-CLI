...
Aqui, o ID completo é `provider_id/model_id`. Por exemplo, se você estiver usando [RAILWISE Zen](/docs/zen), você usaria `railwise/gpt-5.1-codex` para GPT 5.1 Codex.
