import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@railwise/sdk/v2"
...
import { FileComponentProvider } from "@railwise/ui/context/file"
...
import { iife } from "@railwise/shared/util/iife"
import { Binary } from "@railwise/shared/util/binary"
...
import { FileSSR } from "@railwise/ui/file-ssr"
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | RAILWISE</Title>
              </Show>
              <Meta name="description" content="railwise - The AI coding agent built for the terminal." />
