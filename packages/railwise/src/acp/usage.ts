...
import type { AssistantMessage as RAILWISEAssistantMessage, Message } from "@railwise/sdk/v2"
...
export type AssistantTokenCost = Pick<RAILWISEAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<RAILWISEAssistantMessage, "role"> &
  Partial<Pick<RAILWISEAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@railwise/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@railwise/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@railwise/ACPUsage") {}
