...
You can add custom commands through the RAILWISE config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your RAILWISE [config](/docs/config):
