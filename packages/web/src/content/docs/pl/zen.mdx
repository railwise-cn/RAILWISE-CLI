---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez RAILWISE.
---
...
RAILWISE Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół RAILWISE.

Zen działa jak każdy inny dostawca w RAILWISE. Logujesz się do RAILWISE Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z RAILWISE.
:::
...
RAILWISE Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

RAILWISE Zen działa jak każdy inny dostawca w RAILWISE.

1. Logujesz się do **<a href={console}>RAILWISE Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz RAILWISE Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji RAILWISE używa formatu
`railwise/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`railwise/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w RAILWISE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w RAILWISE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w RAILWISE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w RAILWISE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w RAILWISE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
- North Mini Code Free: W czasie darmowego okresu zebrane dane mogą być wykorzystywane do ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w RAILWISE także dowolnego innego dostawcy.
