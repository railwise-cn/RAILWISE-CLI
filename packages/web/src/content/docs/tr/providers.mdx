...
5. Bir model seçmek için `/models` komutunu çalıştırın.
   ...
   Railwise yapılandırmanız aracılığıyla da modeller ekleyebilirsiniz.
...
Daha fazla belge [railwise-gitlab-auth](https://www.npmjs.com/package/@gitlab/railwise-gitlab-auth) ana sayfasında.
...
[Scaleway Generative APIs](https://www.scaleway.com/en/docs/generative-apis/)'yi Railwise ile kullanmak için:
