...
`.yonsoon/commands/test.md` oluştur:
...
yonsoon işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

yonsoon [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/yonsoon/commands/`
- Proje başına: `.yonsoon/commands/`
...
yonsoon, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
