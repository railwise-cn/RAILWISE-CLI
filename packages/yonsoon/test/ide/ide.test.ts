...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders YONSOON_CALLER", () => {
    process.env["YONSOON_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode YONSOON_CALLER", () => {
    process.env["YONSOON_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown YONSOON_CALLER", () => {
    process.env["YONSOON_CALLER"] = "unknown"
