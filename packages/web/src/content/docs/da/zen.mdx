...
:::note
RAILWISE Zen er i øjeblikket i beta.
:::
...
- MiniMax M2.5 Free er tilgængelig på RAILWISE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ring 2.6 1T Free er tilgængelig på RAILWISE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på RAILWISE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
- Ring 2.6 1T Free: I den gratis periode kan indsamlede data blive brugt til at forbedre modellen.
