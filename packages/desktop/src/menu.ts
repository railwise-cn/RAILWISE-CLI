    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://yonsoon.ai/docs"),
            text: "YONSOON (甬算) Documentation",
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/yonsoon"),
            text: "Support Forum",
          }),
          await PredefinedMenuItem.new({
            item: "Separator",
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/yonsoon/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/yonsoon/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),
