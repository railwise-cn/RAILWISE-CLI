...
วางการกำหนดค่า RAILWISE ส่วนกลางของคุณใน `~/.config/railwise/railwise.json` ใช้การกำหนดค่าส่วนกลางสำหรับการตั้งค่าทั้งผู้ใช้ เช่น ธีม ผู้ให้บริการ หรือปุ่มลัด
...
คุณสามารถกำหนดค่าธีมที่คุณต้องการใช้ในการกำหนดค่า RAILWISE ของคุณได้ผ่านตัวเลือก `theme`
