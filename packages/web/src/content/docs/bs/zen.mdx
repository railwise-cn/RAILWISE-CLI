...
`railwise/<model-id>`. Na primjer, za GPT 5.3 Codex u konfiguraciji biste
koristili `railwise/gpt-5.3-codex`.
...
- MiMo V2 Pro Free je dostupan na RAILWISE ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo V2 Omni Free je dostupan na RAILWISE ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
