---
title: Share
description: Share your RAILWISE conversations.
---

RAILWISE's share feature allows you to create public links to your RAILWISE conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, RAILWISE:
...
RAILWISE supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, RAILWISE uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
