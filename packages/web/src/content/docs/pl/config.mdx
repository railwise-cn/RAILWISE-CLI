...
Umieść swoją globalną konfigurację RAILWISE w `~/.config/railwise/railwise.json`. Użyj jej do ustawień ogólnych dla użytkownika, takich jak motywy, domyślny dostawca lub skróty klawiszowe.
...
Skonfiguruj motyw interfejsu RAILWISE za pomocą opcji `theme`.
