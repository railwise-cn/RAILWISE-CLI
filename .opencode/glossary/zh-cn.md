...
- PR #13942: https://github.com/anomalyco/railwise/pull/13942

## Do Not Translate (Locale Additions)

- `RAILWISE` (preserve casing in prose; keep `railwise` only when it is part of commands, package names, paths, or code)
- `RAILWISE Zen`
- `RAILWISE CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `railwise` in prose when referring to the product name; use `RAILWISE`
