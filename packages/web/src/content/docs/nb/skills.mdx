...
Agentferdigheter lar RAILWISE (甬算) oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
railwise søker etter disse stedene:
...
For prosjektlokale stier går railwise opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
railwise viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `railwise.json`:
