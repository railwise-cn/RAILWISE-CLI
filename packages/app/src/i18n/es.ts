export const dict = {
  ...
  "dialog.provider.railwise.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.railwise.tagline": "Modelos optimizados y fiables",
  "dialog.provider.railwiseGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por RAILWISE",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en RAILWISE.",
  ...
  "provider.connect.railwiseZen.line1":
    "RAILWISE Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.railwiseZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.railwiseZen.visit.prefix": "Visita ",
  "provider.connect.railwiseZen.visit.link": "railwise.ai/zen",
  "provider.connect.railwiseZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en RAILWISE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en RAILWISE.",
  ...
  "dialog.plugins.empty": "Plugins configurados en railwise.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de RAILWISE se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de RAILWISE ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de RAILWISE",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (railwise.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, RAILWISE no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "RAILWISE incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor RAILWISE dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para RAILWISE",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve RAILWISE en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si RAILWISE sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de RAILWISE.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia RAILWISE",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de RAILWISE.",
