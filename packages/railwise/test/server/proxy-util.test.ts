...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips railwise-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-railwise-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-railwise-directory")).toBeNull()
      expect(result.get("x-railwise-workspace")).toBeNull()
