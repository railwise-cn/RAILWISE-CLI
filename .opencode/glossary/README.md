...
Use this folder for locale-specific translation guidance that supplements `.railwise/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/railwise/pull/12345

## Do Not Translate (Locale Additions)

- `RAILWISE` (preserve casing)
