...
Utwórz `.railwise/commands/test.md`:
...
Możesz zdefiniować polecenia w `railwise.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji railwise:
...
- Globalnie: `~/.config/railwise/commands/`
- Na projekt: `.railwise/commands/`
...
railwise zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
