---
title: Zen
description: Lista curata di modelli fornita da RAILWISE (甬算).
---
...
RAILWISE (甬算) Zen e una lista di modelli testati e verificati dal team di RAILWISE (甬算).

:::note
RAILWISE (甬算) Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in RAILWISE (甬算). Accedi a RAILWISE (甬算) Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare RAILWISE (甬算).
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con RAILWISE (甬算).
:::
...
RAILWISE (甬算) Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

RAILWISE (甬算) Zen funziona come qualunque altro provider in RAILWISE (甬算).

1. Accedi a **<a href={console}>RAILWISE (甬算) Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona RAILWISE (甬算) Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di RAILWISE (甬算) usa il formato `railwise/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `railwise/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su RAILWISE (甬算) per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su RAILWISE (甬算) per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su RAILWISE (甬算) per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su RAILWISE (甬算) per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato RAILWISE (甬算) Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con RAILWISE (甬算).
