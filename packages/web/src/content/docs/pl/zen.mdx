...
`railwise/<model-id>`. Na przykład dla GPT 5.3 Codex użyjesz w konfiguracji
`railwise/gpt-5.3-codex`.
...
- MiMo V2 Pro Free jest dostępny w RAILWISE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Omni Free jest dostępny w RAILWISE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
