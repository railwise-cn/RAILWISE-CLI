...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/yonsoon.git")).toEqual({ owner: "sst", repo: "yonsoon" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/yonsoon")).toEqual({ owner: "sst", repo: "yonsoon" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/yonsoon.git")).toEqual({ owner: "sst", repo: "yonsoon" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/yonsoon")).toEqual({ owner: "sst", repo: "yonsoon" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/yonsoon.git")).toEqual({ owner: "sst", repo: "yonsoon" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/yonsoon")).toEqual({ owner: "sst", repo: "yonsoon" })
})
