...
RAILWISE est livré avec deux sous-agents intégrés, **General** et **Explore**. Nous verrons cela ci-dessous.

---

## Agents intégrés

RAILWISE est livré avec deux agents primaires intégrés et deux sous-agents intégrés.
...
:::tip
Avez-vous un agent que vous aimeriez partager ? [Soumettez un PR](https://github.com/railwise-cn/RAILWISE-CLI).
:::
