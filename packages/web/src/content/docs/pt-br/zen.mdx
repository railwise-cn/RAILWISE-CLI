...
O Zen funciona como qualquer outro provedor no railwise. Você faz login no RAILWISE Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o railwise.
...
O RAILWISE Zen é um gateway de IA que lhe dá acesso a esses modelos.
