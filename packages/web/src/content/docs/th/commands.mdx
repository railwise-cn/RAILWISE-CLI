...
สร้าง `.railwise/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ RAILWISE (甬算):
...
- ระดับผู้ใช้ (Global): `~/.config/railwise/commands/`
- ระดับโปรเจ็กต์: `.railwise/commands/`
...
RAILWISE (甬算) มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
