...
import compareVideo from "../../asset/lander/yonsoon-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/yonsoon-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="yonsoon:auth" content={loggedin() ? "true" : "false"} />
