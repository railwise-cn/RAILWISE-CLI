...
:::note
RAILWISE Go est actuellement en version bêta.
:::
...
| Qwen3.6 Plus      | qwen3.6-plus      | `https://railwise.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |
| Qwen3.5 Plus      | qwen3.5-plus      | `https://railwise.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |
