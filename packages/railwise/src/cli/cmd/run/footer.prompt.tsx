...
import { normalizePromptContent } from "@railwise/tui/editor"
...
import { RAILWISE_BASE_MODE, useBindings } from "@railwise/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close RAILWISE" } satisfies SlashOption,
    ]
