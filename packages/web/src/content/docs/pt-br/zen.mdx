---
title: Zen
description: Lista selecionada de modelos fornecidos pelo yonsoon.
---
...
O YONSOON (甬算) Zen é uma lista de modelos testados e verificados fornecidos pela equipe do yonsoon.

:::note
O YONSOON (甬算) Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no yonsoon. Você faz login no YONSOON (甬算) Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o yonsoon.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o yonsoon.
:::
...
O YONSOON (甬算) Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O YONSOON (甬算) Zen funciona como qualquer outro provedor no yonsoon.

1. Você faz login no **<a href={console}>YONSOON (甬算) Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona YONSOON (甬算) Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do yonsoon usa o formato `yonsoon/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `yonsoon/gpt-5.2-codex` na sua configuração.
...
- GLM 4.7 Free está disponível no yonsoon por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Kimi K2.5 Free está disponível no yonsoon por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- MiniMax M2.1 Free está disponível no yonsoon por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no yonsoon por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o yonsoon também.
