...
import { AccountStateTable, AccountTable } from "@railwise/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@railwise/AccountRepo") {}
