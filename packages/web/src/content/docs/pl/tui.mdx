---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala yonsoon.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

yonsoon zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie yonsoon uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI yonsoon, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do yonsoon. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij yonsoon. _Aliasy_: `/quit`, `/q`
...
Możesz dostosować zachowanie TUI za pomocą pliku konfiguracyjnego yonsoon.
