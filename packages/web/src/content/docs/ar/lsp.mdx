...
يمكن أن يتكامل RAILWISE مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.
...
عند تفعيل LSP وفتح railwise لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات railwise.
