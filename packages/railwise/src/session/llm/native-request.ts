import type { JsonSchema, LLMRequest, ProviderMetadata } from "@railwise/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@railwise/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @railwise/llm request objects from railwise's session/AI SDK-shaped data.
  return LLM.request({
