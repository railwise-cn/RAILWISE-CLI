...
RAILWISE yapılandırmanızdaki [model id](/docs/config/#models) formatı `railwise-go/<model-id>` şeklindedir. Örneğin, Kimi K2.5 için yapılandırmanızda `railwise-go/kimi-k2.5` kullanmalısınız.
