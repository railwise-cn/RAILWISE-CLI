...
const releaseId = process.env.RAILWISE_RELEASE
if (!releaseId) throw new Error("RAILWISE_RELEASE is required")

const version = process.env.RAILWISE_VERSION
if (!releaseId) throw new Error("RAILWISE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "railwise-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "railwise-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "railwise-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "railwise-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "railwise-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "railwise-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "railwise-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "railwise-desktop-darwin-aarch64.app.tar.gz",
  },
]
