export const dict = {
  ...
  "dialog.provider.railwise.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.railwise.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.railwiseGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af RAILWISE",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i RAILWISE.",
  ...
  "provider.connect.railwiseZen.line1":
    "RAILWISE Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.railwiseZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.railwiseZen.visit.prefix": "Besøg ",
  "provider.connect.railwiseZen.visit.link": "railwise.ai/zen",
  "provider.connect.railwiseZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i RAILWISE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i RAILWISE.",
  ...
  "dialog.server.description": "Skift hvilken RAILWISE-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af RAILWISE ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, RAILWISE understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "RAILWISE inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for RAILWISE",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan RAILWISE ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om RAILWISE følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan RAILWISE er temabestemt.",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af RAILWISE.",
