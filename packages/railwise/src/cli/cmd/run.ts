import type { PermissionV1 } from "@railwise/core/v1/permission"
// CLI entry point for `railwise run`.
//
// Handles three modes:
...
//      railwise server and runs interactive mode against it.
//
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to RAILWISE_SERVER_USERNAME or 'railwise')",
      })
      .option("dir", {
        type: "string",
