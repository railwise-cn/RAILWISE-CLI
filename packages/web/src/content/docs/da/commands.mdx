...
Du kan tilføje brugerdefinerede kommandoer gennem RAILWISE-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din RAILWISE [config](/docs/config):
