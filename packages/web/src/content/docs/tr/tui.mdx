---
title: TUI
description: railwise terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

railwise, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

railwise'u calistirdiginizda mevcut dizin icin TUI baslar.
...
railwise TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
railwise'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
railwise'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini railwise config dosyanizdan ozellestirebilirsiniz.
