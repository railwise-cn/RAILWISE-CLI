...
RAILWISE automatically formats files after they are written or edited using language-specific formatters. This ensures that the code that is generated follows the code styles of your project.
...
So if your project has `prettier` in your `package.json`, RAILWISE will automatically use it.

---

## How it works

When RAILWISE writes or edits a file, it:
...
You can customize formatters through the `formatter` section in your RAILWISE config.
