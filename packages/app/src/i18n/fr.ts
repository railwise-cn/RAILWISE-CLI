export const dict = {
  ...
  "error.page.report.link": "canal de support",
  ...
  "settings.platform.wsl.title": "Intégration WSL",
  "settings.platform.wsl.description": "Exécuter le serveur RAILWISE dans WSL sur Windows.",
  ...
  "settings.updates.row.check.description": "Vérifier manuellement les mises à jour et les appliquer si disponible",
