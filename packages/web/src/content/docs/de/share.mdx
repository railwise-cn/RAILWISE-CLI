---
title: Teilen
description: Teile RAILWISE (甬算)-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu RAILWISE (甬算)-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht RAILWISE (甬算) Folgendes:
...
RAILWISE (甬算) hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt RAILWISE (甬算) den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`railwise.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du railwise in deiner Organisation einsetzt.
