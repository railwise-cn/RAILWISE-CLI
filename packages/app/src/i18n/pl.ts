export const dict = {
  ...
  "dialog.provider.yonsoon.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez YONSOON (甬算)",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w YONSOON (甬算).",
  ...
  "provider.connect.yonsoonZen.line1":
    "YONSOON (甬算) Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.yonsoonZen.visit.prefix": "Odwiedź ",
  "provider.connect.yonsoonZen.visit.link": "yonsoon.ai/zen",
  "provider.connect.yonsoonZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w YONSOON (甬算).",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w YONSOON (甬算).",
  ...
  "dialog.server.description": "Przełącz serwer YONSOON (甬算), z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja YONSOON (甬算) ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu YONSOON (甬算)",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, YONSOON (甬算) does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "YONSOON (甬算) zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the YONSOON (甬算) server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla YONSOON (甬算)",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd YONSOON (甬算) na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw YONSOON (甬算).",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania YONSOON (甬算)",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji YONSOON (甬算).",
