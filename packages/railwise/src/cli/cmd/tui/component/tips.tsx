...
const TIPS = [
  ...
  "Create {highlight}railwise.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/railwise/railwise.json{/highlight} for global config",
  ...
  "RAILWISE (甬算) auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "RAILWISE (甬算) auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "RAILWISE (甬算) uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent RAILWISE (甬算) from reading sensitive files",
  ...
  "Run {highlight}railwise serve{/highlight} for headless API access to RAILWISE (甬算)",
  ...
  "Use {highlight}/connect{/highlight} with RAILWISE (甬算) Zen for curated, tested models",
