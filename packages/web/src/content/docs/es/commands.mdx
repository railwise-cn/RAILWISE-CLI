...
Crear `.railwise/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración RAILWISE (甬算) o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su RAILWISE (甬算) [config](/docs/config):
...
- Por proyecto: `.railwise/commands/`
...
railwise incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
