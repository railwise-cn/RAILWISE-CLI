import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@railwise/llm"
...
// Move this extraction into @railwise/llm when Copilot is handled by the native runtime.
