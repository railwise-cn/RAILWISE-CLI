...
railwise, **General** ve **Explore** olmak üzere iki yerleşik alt agent ile birlikte gelir. Buna aşağıda bakacağız.

---

## Yerleşik

railwise iki yerleşik birincil agent ve iki yerleşik alt agent ile birlikte gelir.
...
railwise hesabınızdaki model kimliğini `provider/model-id` biçimini kullanır. Örneğin, [RAILWISE Zen](/docs/zen) kullanıyorsanız, GPT 5.1 Codex için `railwise/gpt-5.1-codex` kullanırsınız.
...
:::tip
Paylaşmak istediğiniz bir agent'ınız var mı? [Submit a PR](https://github.com/railwise-cn/RAILWISE-CLI).
:::
