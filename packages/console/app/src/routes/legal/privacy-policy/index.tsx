...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>RAILWISE (甬算) | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="RAILWISE (甬算) privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At RAILWISE (甬算), we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of RAILWISE (甬算) is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://railwise.ai/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the RAILWISE (甬算) website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about RAILWISE (甬算).
                </li>
              ...
              <p>
                ...
                you, RAILWISE (甬算) or another party; enforcing any agreements with you; responding to claims that any posting
