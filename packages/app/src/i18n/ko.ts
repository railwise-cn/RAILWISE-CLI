...
export const dict = {
  ...
  "app.name": "RAILWISE",
  "settings.section.application": "앱",
  "settings.section.server": "서버",
  "settings.tab.general": "일반",
  "settings.tab.shortcuts": "단축키",
  "settings.platform.section.wsl": "WSL",
  "settings.platform.wsl.title": "WSL 통합",
  "settings.platform.wsl.description": "Windows의 WSL 내부에서 RAILWISE 서버를 실행합니다.",
