---
title: Zen
description: Utvalgt liste over modeller levert av RAILWISE (甬算).
---
...
RAILWISE (甬算) Zen er en liste over testede og verifiserte modeller levert av RAILWISE (甬算)-teamet.

:::note
RAILWISE (甬算) Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i RAILWISE (甬算). Du logger på RAILWISE (甬算) Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med RAILWISE (甬算).
:::
...
RAILWISE (甬算) Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

RAILWISE (甬算) Zen fungerer som alle andre leverandører i RAILWISE (甬算).

1. Du logger på **<a href={console}>RAILWISE (甬算) Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger RAILWISE (甬算) Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i RAILWISE (甬算)-konfigurasjonen
bruker formatet `railwise/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `railwise/gpt-5.2-codex` i konfigurasjonen din.
...
- GLM 4.7 Free er tilgjengelig på RAILWISE (甬算) i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Kimi K2.5 Free er tilgjengelig på RAILWISE (甬算) i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- MiniMax M2.1 Free er tilgjengelig på RAILWISE (甬算) i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på RAILWISE (甬算) i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet RAILWISE (甬算) Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med railwise også.
