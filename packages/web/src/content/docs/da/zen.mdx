...
bruger formatet `railwise/<model-id>`. For eksempel ville du for GPT 5.3 Codex
bruge `railwise/gpt-5.3-codex` i din konfiguration.
...
- MiMo V2 Pro Free er tilgængelig på RAILWISE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo V2 Omni Free er tilgængelig på RAILWISE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
