...
Agentferdigheter lar YONSOON (甬算) oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
yonsoon søker etter disse stedene:
...
For prosjektlokale stier går yonsoon opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
yonsoon viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `yonsoon.json`:
