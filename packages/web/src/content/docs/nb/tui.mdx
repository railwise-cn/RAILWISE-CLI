---
title: TUI
description: Bruke railwise-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

RAILWISE gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre RAILWISE starter TUI for gjeldende katalog.
...
Når du bruker RAILWISE TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til RAILWISE. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt RAILWISE. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `railwise.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge RAILWISE venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `railwise.default`.
