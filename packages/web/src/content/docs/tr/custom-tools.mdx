---
title: Özel Araçlar
description: LLM'un yonsoon'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. yonsoon'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.yonsoon/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/yonsoon/tools/` içine yerleştirerek.
