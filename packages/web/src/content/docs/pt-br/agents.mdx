...
O ID do modelo em sua configuração do railwise usa o formato `provider/model-id`. Por exemplo, se você estiver usando [RAILWISE (甬算) Zen](/docs/zen), você usaria `railwise/gpt-5.1-codex` para GPT 5.1 Codex.
