...
description: Lag verktøy som LLM kan kalle inn YONSOON (甬算).
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med YONSOON (甬算) sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.yonsoon/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/yonsoon/tools/`.
