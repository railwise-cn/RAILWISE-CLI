...
Puede agregar comandos personalizados a través de la configuración RAILWISE o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su RAILWISE [config](/docs/config):
