export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの RAILWISE を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "RAILWISE のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "RAILWISE ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "RAILWISE CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
