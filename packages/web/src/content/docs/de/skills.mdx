...
Agent Skills erlauben RAILWISE, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
RAILWISE sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft RAILWISE vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
RAILWISE listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
