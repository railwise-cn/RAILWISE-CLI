...
Zen fonctionne comme n'importe quel autre fournisseur dans RAILWISE. Vous vous connectez à RAILWISE Zen et obtenez
...
RAILWISE Zen est une passerelle IA qui vous donne accès à ces modèles.
...
1. Vous vous connectez à **<a href={console}>RAILWISE Zen</a>**, ajoutez votre facturation
...
Le [id du modèle](/docs/config/#models) dans votre configuration RAILWISE
...
- GLM 4.7 Free est disponible sur RAILWISE pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Kimi K2.5 Free est disponible sur RAILWISE pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- MiniMax M2.1 Free est disponible sur RAILWISE pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Big Pickle est un modèle furtif gratuit sur RAILWISE pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
...
4. N'ayez **aucun verrouillage** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et laissez-vous toujours utiliser n'importe quel autre fournisseur avec RAILWISE également.
