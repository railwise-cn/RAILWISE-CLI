---
title: Paylasim
description: railwise konusmalarini genel baglantilarla paylasin.
---

railwise'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda railwise:
...
railwise, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak railwise manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `railwise.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda railwise kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
