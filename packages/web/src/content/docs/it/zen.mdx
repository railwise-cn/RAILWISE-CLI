---
title: Zen
description: Lista curata di modelli fornita da RAILWISE.
---
...
RAILWISE Zen è un elenco di modelli testati e verificati forniti dal team di RAILWISE.

Zen funziona come qualsiasi altro provider in RAILWISE. Accedi a RAILWISE Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con RAILWISE.
:::
...
RAILWISE Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

RAILWISE Zen funziona come qualsiasi altro provider in RAILWISE.

1. Accedi a **<a href={console}>RAILWISE Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona RAILWISE Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di RAILWISE
usa il formato `railwise/<model-id>`. Per esempio, per GPT 5.5, useresti
`railwise/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su RAILWISE per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su RAILWISE per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su RAILWISE per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su RAILWISE per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su RAILWISE per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
- North Mini Code Free: durante il periodo gratuito, i dati raccolti possono essere usati per migliorare il modello.
...
Abbiamo creato RAILWISE Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con RAILWISE.
