...
export const dict = {
  ...
  "home.title": "RAILWISE (甬算) | Açık kaynaklı yapay zeka kodlama ajanı",
  ...
  "home.what.title": "RAILWISE (甬算) nedir?",
  "home.what.body":
    "RAILWISE (甬算), terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yıldız, <strong>{{contributors}}</strong> katılımcı ve <strong>{{commits}}</strong>+ commit ile RAILWISE (甬算), her ay <strong>{{monthlyUsers}}</strong>+ geliştirici tarafından kullanılıyor ve güveniliyor.",
  ...
  "home.privacy.body":
    "RAILWISE (甬算) kodunuzu veya bağlam verilerinizi saklamaz; bu sayede gizliliğe duyarlı ortamlarda çalışabilir.",
  "home.privacy.learnMore": "Hakkında daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "RAILWISE (甬算) nedir?",
  "home.faq.a1":
    "RAILWISE (甬算), herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  "home.faq.q2": "RAILWISE (甬算)'u nasıl kullanırım?",
  "home.faq.a2.before": "Başlamanın en kolay yolu",
  "home.faq.a2.link": "girişi okumaktır",
  "home.faq.q3": "RAILWISE (甬算) için ek AI aboneliklerine ihtiyacım var mı?",
  "home.faq.a3.p1": "Şart değil. RAILWISE (甬算), hesap açmadan kullanabileceğiniz ücretsiz modellerle gelir.",
  ...
  "home.faq.a3.p3": "Zen'i öneriyoruz, ancak RAILWISE (甬算) OpenAI, Anthropic, xAI gibi popüler sağlayıcılarla da çalışır.",
  "home.faq.a3.p4.beforeLocal": "Hatta",
  "home.faq.a3.p4.localLink": "yerel modellerinizi",
  "home.faq.q4": "Mevcut AI aboneliklerimi RAILWISE (甬算) ile kullanabilir miyim?",
  "home.faq.a4.p1":
    "Evet. RAILWISE (甬算) tüm büyük sağlayıcıların aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "RAILWISE (甬算)'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! RAILWISE (甬算) şimdi",
  "home.faq.a5.desktop": "masaüstü",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "RAILWISE (甬算) ne kadar?",
  "home.faq.a6":
    "RAILWISE (甬算) %100 ücretsizdir. Ayrıca ücretsiz model setiyle gelir. Başka bir sağlayıcı bağlarsanız ek maliyetler olabilir.",
  ...
  "home.faq.q8": "RAILWISE (甬算) açık kaynak mı?",
  "home.faq.a8.p1": "Evet, RAILWISE (甬算) tamamen açık kaynaktır. Kaynak kodu",
  ...
  "home.zenCta.body":
    "Zen, RAILWISE (甬算)'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",
  "home.zenCta.link": "Zen hakkında",

  "zen.title": "RAILWISE (甬算) Zen | Kodlama ajanları için güvenilir, optimize edilmiş modellerin seçilmiş seti",
  "zen.hero.title": "Kodlama ajanları için güvenilir, optimize modeller",
  "zen.hero.body":
    "Zen, RAILWISE (甬算)'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",

  "zen.faq.q1": "RAILWISE (甬算) Zen nedir?",
  "zen.faq.a1":
    "Zen, RAILWISE (甬算) ekibi tarafından oluşturulan ve kodlama ajanları için test edilip benchmark edilen seçilmiş bir AI model setidir.",
  ...
  "zen.faq.a3":
    "Zen kâr amaçlı değildir. Zen, model sağlayıcılarının maliyetlerini size yansıtır. Zen'in kullanımı arttıkça RAILWISE (甬算) daha iyi fiyatlar pazarlayabilir ve bunları size yansıtabilir.",
  ...
  "zen.faq.a4.p3":
    "Maliyetleri karşılamak için RAILWISE (甬算), $20 bakiye yüklemesi başına yalnızca $1.23 tutarında küçük bir ödeme işleme ücreti ekler.",
  ...
  "zen.faq.a8":
    "Zen RAILWISE (甬算) ile harika çalışır, ama Zen'i herhangi bir ajan ile kullanabilirsiniz. Tercih ettiğiniz kodlama ajanında kurulum talimatlarını izleyin.",
  ...
  "zen.problem.subtitle": "Bu sorunu yalnızca RAILWISE (甬算) kullanıcıları için değil, herkes için düzeltiyoruz.",
  ...
  "zen.how.body": "Zen'i RAILWISE (甬算) ile kullanmanızı önersek de, Zen'i herhangi bir ajan ile kullanabilirsiniz.",
  ...
  "black.meta.title": "RAILWISE (甬算) Black | Dünyanın en iyi kodlama modellerine erişin",
  "black.meta.description": "RAILWISE (甬算) Black abonelik planlarıyla Claude, GPT, Gemini ve daha fazlasına erişin.",
  "black.hero.title": "Dünyanın en iyi kodlama modellerine erişin",
  "black.hero.subtitle": "Claude, GPT, Gemini ve daha fazlası dahil",
  "black.title": "RAILWISE (甬算) Black | Fiyatlandırma",
  ...
  "black.workspace.title": "RAILWISE (甬算) Black | Çalışma Alanı Seç",
  "black.workspace.selectPlan": "Bu plan için bir çalışma alanı seçin",
  "black.workspace.name": "Çalışma Alanı {{n}}",
  "black.subscribe.title": "RAILWISE (甬算) Black'e Abone Ol",
  ...
  "black.subscribe.success.title": "RAILWISE (甬算) Black bekleme listesindesiniz",
  ...
  "workspace.black.subscription.message": "Aylık ${{plan}} karşılığında RAILWISE (甬算) Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} RAILWISE (甬算) Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki RAILWISE (甬算) Black planına kaydetmeye hazırız.",
  ...
  "download.title": "RAILWISE (甬算) | İndir",
  "download.meta.description": "RAILWISE (甬算)'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "RAILWISE (甬算)'u İndir",
  ...
  "download.section.extensions": "RAILWISE (甬算) Eklentileri",
  "download.section.integrations": "RAILWISE (甬算) Entegrasyonları",
  ...
  "download.faq.a3.beforeLocal":
    "Tam olarak değil, ama muhtemelen. RAILWISE (甬算)'u ücretli bir sağlayıcıya bağlamak istiyorsanız bir AI aboneliği gerekir, ancak",
  ...
  "download.faq.a3.afterZen":
    " kullanmaya teşvik ediyoruz, ancak RAILWISE (甬算) OpenAI, Anthropic, xAI vb. gibi tüm popüler sağlayıcılarla çalışır.",

  "download.faq.a5.p1": "RAILWISE (甬算) %100 ücretsizdir.",
  "download.faq.a5.p2.beforeZen":
    "Ek maliyetler, bir model sağlayıcısına olan aboneliğinizden gelir. RAILWISE (甬算) herhangi bir model sağlayıcısıyla çalışır, ancak",
  "download.faq.a5.p2.afterZen": " kullanmanızı öneririz.",

  "download.faq.a6.p1":
    "Verileriniz ve bilginiz yalnızca RAILWISE (甬算)'da paylaşılabilir bağlantılar oluşturduğunuzda saklanır.",
  "download.faq.a6.p2.beforeShare": "Daha fazla bilgi:",
  "download.faq.a6.shareLink": "paylaşım sayfaları",

  "enterprise.title": "RAILWISE (甬算) | Kurumunuz için kurumsal çözümler",
  "enterprise.meta.description": "Kurumsal çözümler için RAILWISE (甬算) ile iletişime geçin",
  "enterprise.hero.title": "Kodunuz size aittir",
  "enterprise.hero.body1":
    "RAILWISE (甬算), hiçbir veri veya bağlam saklamadan ve lisans kısıtlamaları ya da sahiplik iddiaları olmadan kuruluşunuzun içinde güvenli şekilde çalışır. Ekibinizle bir deneme başlatın, ardından SSO'nuz ve dahili AI geçidiniz ile entegre ederek tüm kuruluşunuzda devreye alın.",
  ...
  "enterprise.faq.q1": "RAILWISE (甬算) Enterprise nedir?",
  "enterprise.faq.a1":
    "RAILWISE (甬算) Enterprise, kodunuzun ve verilerinizin asla altyapınızı terk etmemesini sağlamak isteyen kurumlar içindir. Bunu, SSO'nuz ve dahili AI geçidiniz ile entegre olan merkezileştirilmiş bir konfigürasyonla sağlar.",
  "enterprise.faq.q2": "RAILWISE (甬算) Enterprise'a nasıl başlarım?",
  "enterprise.faq.a2":
    "Ekibinizle dahili bir deneme ile başlayın. RAILWISE (甬算) varsayılan olarak kodunuzu veya bağlam verilerinizi saklamaz, bu da başlamayı kolaylaştırır. Ardından fiyatlandırma ve uygulama seçeneklerini görüşmek için bize ulaşın.",
  ...
  "enterprise.faq.q4": "RAILWISE (甬算) Enterprise ile verilerim güvende mi?",
  "enterprise.faq.a4":
    "Evet. RAILWISE (甬算) kodunuzu veya bağlam verilerinizi saklamaz. Tüm işleme yerel olarak ya da AI sağlayıcınıza doğrudan API çağrıları ile gerçekleştirilir. Merkezileştirilmiş konfigürasyon ve SSO entegrasyonu ile verileriniz kurumunuzun altyapısı içinde güvende kalır.",

  "brand.title": "RAILWISE (甬算) | Marka",
  "brand.meta.description": "RAILWISE (甬算) marka kılavuzu",
  "brand.heading": "Marka kılavuzu",
  "brand.subtitle": "RAILWISE (甬算) markası ile çalışmanıza yardımcı olacak kaynaklar ve varlıklar.",
  "brand.downloadAll": "Tüm varlıkları indir",

  "changelog.title": "RAILWISE (甬算) | Değişiklik günlüğü",
  "changelog.meta.description": "RAILWISE (甬算) sürüm notları ve değişiklik günlüğü",
  "changelog.hero.title": "Değişiklik günlüğü",
  "changelog.hero.subtitle": "RAILWISE (甬算) için yeni güncellemeler ve iyileştirmeler",
