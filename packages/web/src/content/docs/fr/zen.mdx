---
title: Zen
description: Liste organisée de modèles fournis par RAILWISE (甬算).
---
...
RAILWISE (甬算) Zen est une liste de modèles testés et vérifiés fournie par l'équipe RAILWISE (甬算).

:::note
RAILWISE (甬算) Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans RAILWISE (甬算). Vous vous connectez à RAILWISE (甬算) Zen et obtenez
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec RAILWISE (甬算).
:::
...
RAILWISE (甬算) Zen est une passerelle IA qui vous donne accès à ces modèles.

---

## Comment ça marche

RAILWISE (甬算) Zen fonctionne comme n'importe quel autre fournisseur dans RAILWISE (甬算).

1. Vous vous connectez à **<a href={console}>RAILWISE (甬算) Zen</a>**, ajoutez votre facturation
   détails et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez RAILWISE (甬算) Zen et collez votre clé API.
...
| Gemini 3 Pro       | gemini-3-pro       | `https://railwise.ai/zen/v1/models/gemini-3-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash     | gemini-3-flash     | `https://railwise.ai/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| MiniMax M2.1       | minimax-m2.1       | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.1 Free  | minimax-m2.1-free  | `https://railwise.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7            | glm-4.7            | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Free       | glm-4.7-free       | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.6            | glm-4.6            | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5          | kimi-k2.5          | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5 Free     | kimi-k2.5-free     | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Thinking   | kimi-k2-thinking   | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2            | kimi-k2            | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3 Coder 480B   | qwen3-coder        | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle         | big-pickle         | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Le [id du modèle](/docs/config/#models) dans votre configuration RAILWISE (甬算)
utilise le format `railwise/<model-id>`. Par exemple, pour GPT 5.2 Codex, vous devez
utilisez `railwise/gpt-5.2-codex` dans votre configuration.
...
- GLM 4.7 Free est disponible sur RAILWISE (甬算) pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Kimi K2.5 Free est disponible sur RAILWISE (甬算) pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- MiniMax M2.1 Free est disponible sur RAILWISE (甬算) pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Big Pickle est un modèle furtif gratuit sur RAILWISE (甬算) pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
...
Nous avons créé RAILWISE (甬算) Zen pour :
...
4. N'ayez **aucun verrouillage** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et laissez-vous toujours utiliser n'importe quel autre fournisseur avec RAILWISE (甬算) également.
