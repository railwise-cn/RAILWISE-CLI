...
description: yonsoon dile özgü biçimlendiriciler kullanır.
---

yonsoon, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

yonsoon, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, yonsoon bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

yonsoon bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri yonsoon yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
