...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@railwise/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@railwise/ACPDirectory") {}
