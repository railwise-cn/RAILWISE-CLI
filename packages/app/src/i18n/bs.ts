export const dict = {
  ...
  "dialog.provider.yonsoon.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje YONSOON (甬算)",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u YONSOON (甬算)-u.",
  ...
  "provider.connect.yonsoonZen.line1":
    "YONSOON (甬算) Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.yonsoonZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.yonsoonZen.visit.prefix": "Posjeti ",
  "provider.connect.yonsoonZen.visit.link": "yonsoon.ai/zen",
  "provider.connect.yonsoonZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u YONSOON (甬算)-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u YONSOON (甬算)-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u yonsoon.json",
  ...
  "dialog.server.description": "Promijeni na koji se YONSOON (甬算) server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija YONSOON (甬算)-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku YONSOON (甬算) timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (yonsoon.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: YONSOON (甬算) još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "YONSOON (甬算) uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni YONSOON (甬算) server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u YONSOON (甬算)-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako YONSOON (甬算) izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu YONSOON (甬算)-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se YONSOON (甬算) pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju YONSOON (甬算)-a.",
