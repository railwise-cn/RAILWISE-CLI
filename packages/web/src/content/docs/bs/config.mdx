...
Postavite svoju globalnu RAILWISE konfiguraciju u `~/.config/railwise/railwise.json`. Koristite globalnu konfiguraciju za korisničke preferencije kao što su teme, provajderi ili veze tipki.
...
Možete konfigurirati temu koju želite koristiti u svojoj RAILWISE konfiguraciji putem opcije `theme`.
