...
export const RootHttpApi = HttpApi.make("railwise-root")
...
export const InstanceHttpApi = HttpApi.make("railwise-instance")
...
export const RAILWISEHttpApi = HttpApi.make("railwise")
