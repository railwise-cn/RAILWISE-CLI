...
RAILWISE comes with two built-in subagents, **General** and **Explore**. We'll look at this below.

---

## Built-in

RAILWISE comes with two built-in primary agents and two built-in subagents.
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/railwise-cn/RAILWISE-CLI).
:::
