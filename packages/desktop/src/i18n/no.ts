export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av RAILWISE (甬算)",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av RAILWISE (甬算) er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'railwise'-kommandoen.",
