---
title: TUI
description: Using the RAILWISE (甬算) terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

RAILWISE (甬算) provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running RAILWISE (甬算) starts the TUI for the current directory.
...
When using the RAILWISE (甬算) TUI, you can type `/` followed by a command name to quickly execute actions. For example:
