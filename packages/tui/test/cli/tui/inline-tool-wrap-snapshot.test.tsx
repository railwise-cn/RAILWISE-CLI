...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "RAILWISE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/railwise/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/railwise (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/railwise/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/railwise/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const RAILWISE_DB|RAILWISE_DB|RAILWISE_DEV|Global\\.Path\\.data|data =" in packages/railwise/src (115 matches)',
  },
] as const
