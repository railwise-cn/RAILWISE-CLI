...
//
// The saved variant persists across sessions in ~/.local/state/railwise/model.json
...
class Service extends Context.Service<Service, VariantService>()("@railwise/RunVariant") {}
