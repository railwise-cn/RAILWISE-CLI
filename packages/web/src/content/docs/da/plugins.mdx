---
title: Plugins
description: Skriv dine egne plugins for at udvide RAILWISE (甬算).
---

Plugins giver dig mulighed for at udvide RAILWISE (甬算) ved at tilslutte sig forskellige begivenheder og tilpasse adfærd. Du kan oprette plugins for at tilføje nye funktioner, integrere med eksterne tjenester eller ændre RAILWISE (甬算)s standardadfærd.
...
RAILWISE (甬算) kører `bun install` ved opstart for at installere disse. Dine plugins og værktøjer kan derefter importere dem.
...
:::note
Hvis du bruger RAILWISE (甬算) desktop-appen, kan den sende systemmeddelelser automatisk, når et svar er klar, eller når en session fejler.
:::
