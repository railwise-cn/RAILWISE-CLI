---
title: Zen
description: railwise ekibinin sundugu secili model listesi.
---
...
RAILWISE (甬算) Zen, railwise ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
RAILWISE (甬算) Zen su anda beta asamasindadir.
:::

Zen, railwise'daki diger provider'lar gibi calisir. RAILWISE (甬算) Zen'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; railwise kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
railwise ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
RAILWISE (甬算) Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

RAILWISE (甬算) Zen, railwise'daki diger provider'lar gibi calisir.

1. **<a href={console}>RAILWISE (甬算) Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, RAILWISE (甬算) Zen'i secin ve API anahtarinizi yapistirin
...
railwise config'inizdeki [model id](/docs/config/#models), `railwise/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `railwise/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin railwise'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin railwise'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin railwise'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin railwise'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
RAILWISE (甬算) Zen'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve railwise'da diger provider'lari her zaman acik tutmak
