...
Du kan legge til egendefinerte kommandoer gjennom RAILWISE-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i RAILWISE [config](/docs/config):
...
RAILWISE inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
