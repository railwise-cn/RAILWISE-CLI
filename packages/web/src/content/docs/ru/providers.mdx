...
1. Запустите команду `/connect` в TUI, выберите railwise и перейдите по адресу [railwise.ai/auth](https://railwise.ai/auth).
...
Дополнительная документация на домашней странице [railwise-gitlab-auth](https://www.npmjs.com/package/@gitlab/railwise-gitlab-auth).
