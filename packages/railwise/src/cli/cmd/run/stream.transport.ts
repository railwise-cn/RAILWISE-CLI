...
import type { Event, GlobalEvent, OpencodeClient } from "@railwise/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@railwise/RunStreamTransport") {}
