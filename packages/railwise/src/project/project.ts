...
export namespace Project {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@railwise/Project") {}
  ...
  > = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const fakeVcs = Info.shape.vcs.parse(Flag.RAILWISE_FAKE_VCS)
      ...
      const fromDirectory = Effect.fn("Project.fromDirectory")(function* (directory: string) {
        ...
        if (Flag.RAILWISE_EXPERIMENTAL_ICON_DISCOVERY)
