export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von RAILWISE",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von RAILWISE wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.menu.help.documentation": "RAILWISE-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das RAILWISE CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
