---
title: TUI
description: Bruke yonsoon-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

yonsoon gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre yonsoon starter TUI for gjeldende katalog.
...
Når du bruker yonsoon TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til yonsoon. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt yonsoon. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom yonsoon-konfigurasjonsfilen.
