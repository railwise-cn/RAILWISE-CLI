...
const statsHomeFallbackUrl = "https://railwise.ai/stats/"
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.railwise.ai") return "https://railwise.ai/stats/"
  if (url.hostname === "stats.dev.railwise.ai") return "https://dev.railwise.ai/stats/"
  return url.toString()
}
