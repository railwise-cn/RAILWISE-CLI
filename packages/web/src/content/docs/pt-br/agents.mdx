...
railwise vem com dois subagentes integrados, **General** e **Explore**. Vamos ver isso abaixo.

---

## Integrados

railwise vem com dois agentes primários integrados e dois subagentes integrados.
...
:::tip
Você tem um agente que gostaria de compartilhar? [Envie um PR](https://github.com/railwise-cn/RAILWISE-CLI).
:::
