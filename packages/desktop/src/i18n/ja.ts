export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの RAILWISE (甬算) を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "RAILWISE (甬算) のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'railwise' コマンドを使用してください。",
