export const dict = {
  ...
  "error.page.report.link": "canal de suporte",
  ...
  "app.name": "RAILWISE",
  "settings.section.application": "Aplicativo",
  "settings.section.server": "Servidor",
  "settings.tab.general": "Geral",
  "settings.tab.shortcuts": "Atalhos",
  "settings.platform.section.wsl": "WSL",
  "settings.platform.wsl.title": "WSL integration",
  "settings.platform.wsl.description": "Executar o servidor RAILWISE dentro do WSL no Windows.",
