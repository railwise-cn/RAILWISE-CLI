...
import { httpClient, path } from "@railwise/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@railwise/SkillDiscovery") {}
