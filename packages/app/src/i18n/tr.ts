...
export const dict = {
  ...
  "dialog.provider.railwise.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.railwise.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.railwiseGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "RAILWISE tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve RAILWISE'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.railwiseZen.line1":
    "RAILWISE Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.railwiseZen.visit.prefix": "",
  "provider.connect.railwiseZen.visit.link": "railwise.ai/zen",
  "provider.connect.railwiseZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve RAILWISE'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak RAILWISE'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler railwise.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi RAILWISE sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "RAILWISE'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı RAILWISE ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (railwise.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: RAILWISE henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "RAILWISE ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "RAILWISE Masaüstü",
  ...
  "settings.desktop.wsl.description": "RAILWISE sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "RAILWISE'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "RAILWISE'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "RAILWISE'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "RAILWISE'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "RAILWISE başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "RAILWISE'un en son sürümünü kullanıyorsunuz.",
