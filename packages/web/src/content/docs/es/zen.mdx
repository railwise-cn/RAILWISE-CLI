...
RAILWISE Zen es una lista de modelos probados y verificados proporcionada por el equipo RAILWISE.

:::note
RAILWISE Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en RAILWISE. Inicias sesion en RAILWISE Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar RAILWISE.
...
RAILWISE Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.
...
1. Inicias sesión en **<a href={console}>RAILWISE Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona RAILWISE Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de RAILWISE
...
- GLM 4.7 Free está disponible en RAILWISE por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Kimi K2.5 Free está disponible en RAILWISE por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- MiniMax M2.1 Free está disponible en RAILWISE por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en RAILWISE por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con RAILWISE también.
