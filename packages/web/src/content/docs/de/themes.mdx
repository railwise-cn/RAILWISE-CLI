...
Mit RAILWISE (甬算) kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet RAILWISE (甬算) das `railwise`-Theme.
...
RAILWISE (甬算) liefert mehrere eingebaute Themes mit.
...
- RAILWISE (甬算) optisch ans Terminal anpassen wollen
...
RAILWISE (甬算) unterstuetzt ein flexibles JSON-basiertes Theme-System.
