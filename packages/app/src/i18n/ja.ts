export const dict = {
  ...
  "app.name": "RAILWISE",
  "settings.section.application": "アプリ",
  "settings.section.server": "サーバー",
  "settings.tab.general": "一般",
  "settings.tab.shortcuts": "ショートカット",
  "settings.platform.section.wsl": "WSL",
  "settings.platform.wsl.title": "WSL連携",
  "settings.platform.wsl.description": "WindowsのWSL環境でRAILWISEサーバーを実行します。",
