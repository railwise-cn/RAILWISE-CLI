...
import { createOpencodeClient } from "@railwise/sdk/v2/client"
import { ServerAuth } from "@railwise/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@railwise/cli/Daemon") {}
