...
RAILWISE Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół railwise.

:::note
RAILWISE Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca railwise. Logujesz się do RAILWISE Zen i dostajesz
...
RAILWISE Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

RAILWISE Zen działa jak każdy inny dostawca railwise.

1. Logujesz się do **<a href={console}>RAILWISE Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz RAILWISE Zen i wklejasz klucz API.
