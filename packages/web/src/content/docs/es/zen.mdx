...
usa el formato `railwise/<model-id>`. Por ejemplo, para GPT 5.3 Codex, usarías
`railwise/gpt-5.3-codex` en tu configuración.
...
- MiMo V2 Pro Free está disponible en RAILWISE por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo V2 Omni Free está disponible en RAILWISE por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
