...
export const dict = {
  ...
  "notFound.title": "No encontrado | yonsoon",
  ...
  "home.title": "YONSOON (甬算) | El agente de codificación IA de código abierto",

  "temp.title": "yonsoon | Agente de codificación IA creado para la terminal",
  ...
  "temp.feature.zen.afterLink": "proporcionada por yonsoon",
  ...
  "temp.screenshot.caption": "yonsoon TUI con el tema tokyonight",
  "temp.screenshot.alt": "yonsoon TUI con tema tokyonight",
  ...
  "home.what.title": "¿Qué es YONSOON (甬算)?",
  "home.what.body":
    "YONSOON (甬算) es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, YONSOON (甬算) es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "YONSOON (甬算) no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es YONSOON (甬算)?",
  "home.faq.a1":
    "YONSOON (甬算) es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso YONSOON (甬算)?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar YONSOON (甬算)?",
  "home.faq.a3.p1":
    "No necesariamente, YONSOON (甬算) viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, YONSOON (甬算) también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con YONSOON (甬算)?",
  "home.faq.a4.p1":
    "Sí, YONSOON (甬算) soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar YONSOON (甬算) en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! YONSOON (甬算) ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta YONSOON (甬算)?",
  "home.faq.a6":
    "YONSOON (甬算) es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es YONSOON (甬算) de código abierto?",
  "home.faq.a8.p1": "Sí, YONSOON (甬算) es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que YONSOON (甬算) ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "YONSOON (甬算) Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que YONSOON (甬算) ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es YONSOON (甬算) Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de YONSOON (甬算).",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá YONSOON (甬算) negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, YONSOON (甬算) añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con YONSOON (甬算), puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de YONSOON (甬算).",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con YONSOON (甬算), puedes usar Zen con cualquier agente.",
  ...
  "black.meta.title": "YONSOON (甬算) Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de YONSOON (甬算) Black.",
  ...
  "black.title": "YONSOON (甬算) Black | Precios",
  ...
  "black.workspace.title": "YONSOON (甬算) Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a YONSOON (甬算) Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de YONSOON (甬算) Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con yonsoon cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona yonsoon",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia yonsoon y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de yonsoon.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de yonsoon Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a YONSOON (甬算) Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan YONSOON (甬算) Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan YONSOON (甬算) Black de ${{plan}} al mes.",
  ...
  "download.title": "YONSOON (甬算) | Descargar",
  "download.meta.description": "Descarga YONSOON (甬算) para macOS, Windows y Linux",
  "download.hero.title": "Descargar YONSOON (甬算)",
  ...
  "download.section.desktop": "YONSOON (甬算) Desktop (Beta)",
  "download.section.extensions": "Extensiones YONSOON (甬算)",
  "download.section.integrations": "Integraciones YONSOON (甬算)",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar YONSOON (甬算) a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", YONSOON (甬算) funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "YONSOON (甬算) es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque YONSOON (甬算) funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en YONSOON (甬算).",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "YONSOON (甬算) | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a YONSOON (甬算) para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "YONSOON (甬算) opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es YONSOON (甬算) Enterprise?",
  "enterprise.faq.a1":
    "YONSOON (甬算) Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con YONSOON (甬算) Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. YONSOON (甬算) por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con YONSOON (甬算) Enterprise?",
  "enterprise.faq.a4":
    "Sí. YONSOON (甬算) no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "YONSOON (甬算) | Marca",
  "brand.meta.description": "Guías de marca de YONSOON (甬算)",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca YONSOON (甬算).",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "YONSOON (甬算) | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de YONSOON (甬算)",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para YONSOON (甬算)",
