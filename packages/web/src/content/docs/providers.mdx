...
- **OAuth (Recommended)** — Sign in to your DigitalOcean account; RAILWISE auto-creates a Model Access Key and discovers your available Models & Inference Routers.
...
3. Your browser opens to authorize RAILWISE. Sign in and approve.
   ...
   :::note
   RAILWISE creates a Model Access Key named `railwise-oauth-<timestamp>` in your DigitalOcean account. You can rotate or revoke it from the **Model Access Keys** page in the "Manage" section of the DigitalOcean console under Inference.
   :::
