...
| MiMo-V2-Pro  | mimo-v2-pro  | `https://railwise.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Omni | mimo-v2-omni | `https://railwise.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
...
L'[ID de modèle](/docs/config/#models) dans votre configuration RAILWISE utilise le format `railwise-go/<model-id>`. Par exemple, pour Kimi K2.5, vous utiliseriez `railwise-go/kimi-k2.5` dans votre configuration.
