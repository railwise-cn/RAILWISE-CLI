...
RAILWISE (甬算) Zen, railwise ekibi tarafından sağlanan modellerin bir listesidir.
railwise ile iyi çalıştığı test edilip doğrulandı. [Daha fazla bilgi](/docs/zen).

:::tip
Yeniyseniz RAILWISE (甬算) Zen ile başlamanızı öneririz.
:::
...
RAILWISE (甬算) Zen, railwise ekibinin test edip doğruladığı modellerin bir listesidir. [Daha fazla bilgi](/docs/zen).

1. **<a href={console}>RAILWISE (甬算) Zen</a>**'de oturum açın ve **API Anahtarı Oluştur**'u tıklayın.

2. `/connect` komutunu çalıştırın ve **RAILWISE (甬算) Zen**'i arayın.
