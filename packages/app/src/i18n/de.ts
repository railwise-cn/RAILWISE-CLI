...
export const dict = {
  ...
  "error.page.report.link": "Support-Kanal",
  ...
  "app.name": "RAILWISE",
  "settings.section.application": "App",
  ...
  "settings.platform.wsl.description": "RAILWISE-Server innerhalb von WSL unter Windows ausführen.",
