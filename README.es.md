...
RAILWISE incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://railwise.ai/docs/agents).
...
### Proyectos basados en RAILWISE

Si estás trabajando en un proyecto basado en RAILWISE y usas "railwise" como parte del nombre, por ejemplo, "railwise-dashboard" u "railwise-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de RAILWISE y que no está afiliado con nosotros de ninguna manera.
