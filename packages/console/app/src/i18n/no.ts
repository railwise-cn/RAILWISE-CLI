...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | yonsoon",
  ...
  "home.title": "YONSOON (甬算) | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "yonsoon | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av yonsoon",
  ...
  "temp.screenshot.caption": "yonsoon TUI med tokyonight-tema",
  "temp.screenshot.alt": "yonsoon TUI med tokyonight-tema",
  ...
  "home.what.title": "Hva er YONSOON (甬算)?",
  "home.what.body": "YONSOON (甬算) er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes YONSOON (甬算) av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "YONSOON (甬算) lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er YONSOON (甬算)?",
  "home.faq.a1":
    "YONSOON (甬算) er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg YONSOON (甬算)?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke YONSOON (甬算)?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. YONSOON (甬算) kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men YONSOON (甬算) fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med YONSOON (甬算)?",
  "home.faq.a4.p1":
    "Ja, YONSOON (甬算) støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke YONSOON (甬算) i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! YONSOON (甬算) er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster YONSOON (甬算)?",
  "home.faq.a6":
    "YONSOON (甬算) er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er YONSOON (甬算) åpen kildekode?",
  "home.faq.a8.p1": "Ja, YONSOON (甬算) er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som YONSOON (甬算) har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "YONSOON (甬算) Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som YONSOON (甬算) har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er YONSOON (甬算) Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak YONSOON (甬算).",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan YONSOON (甬算) forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger YONSOON (甬算) til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med YONSOON (甬算), kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare YONSOON (甬算)-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med YONSOON (甬算), kan du bruke Zen med hvilken som helst agent.",
  ...
  "black.meta.title": "YONSOON (甬算) Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med YONSOON (甬算) Black-abonnementer.",
  "black.hero.title": "Få tilgang til verdens beste kodemodeller",
  "black.hero.subtitle": "Inkludert Claude, GPT, Gemini og mer",
  "black.title": "YONSOON (甬算) Black | Priser",
  ...
  "black.workspace.title": "YONSOON (甬算) Black | Velg arbeidsområde",
  "black.workspace.selectPlan": "Velg et arbeidsområde for denne planen",
  "black.workspace.name": "Arbeidsområde {{n}}",
  "black.subscribe.title": "Abonner på YONSOON (甬算) Black",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for YONSOON (甬算) Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med yonsoon når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg yonsoon",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start yonsoon og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til yonsoon-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en yonsoon Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på YONSOON (甬算) Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for YONSOON (甬算) Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på YONSOON (甬算) Black-planen til ${{plan}} per måned.",
  ...
  "download.title": "YONSOON (甬算) | Last ned",
  "download.meta.description": "Last ned YONSOON (甬算) for macOS, Windows og Linux",
  "download.hero.title": "Last ned YONSOON (甬算)",
  ...
  "download.section.extensions": "YONSOON (甬算) Extensions",
  "download.section.integrations": "YONSOON (甬算) Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble YONSOON (甬算) til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer YONSOON (甬算) med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "YONSOON (甬算) er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om YONSOON (甬算) fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i YONSOON (甬算).",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "YONSOON (甬算) | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt YONSOON (甬算) for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "YONSOON (甬算) opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er YONSOON (甬算) Enterprise?",
  "enterprise.faq.a1":
    "YONSOON (甬算) Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med YONSOON (甬算) Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. YONSOON (甬算) lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med YONSOON (甬算) Enterprise?",
  "enterprise.faq.a4":
    "Ja. YONSOON (甬算) lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "YONSOON (甬算) | Merkevare",
  "brand.meta.description": "YONSOON (甬算) retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med YONSOON (甬算)-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "YONSOON (甬算) | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for YONSOON (甬算)",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for YONSOON (甬算)",
