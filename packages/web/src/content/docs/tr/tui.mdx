---
title: TUI
description: yonsoon terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

yonsoon, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

yonsoon'u calistirdiginizda mevcut dizin icin TUI baslar.
...
yonsoon TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
yonsoon'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
yonsoon'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini yonsoon config dosyanizdan ozellestirebilirsiniz.
