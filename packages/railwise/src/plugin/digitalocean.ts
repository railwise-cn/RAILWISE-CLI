...
import type { Model } from "@railwise/sdk/v2"
...
const MAK_NAME_PREFIX = "railwise-oauth"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>RAILWISE - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to RAILWISE."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              ...
              instructions:
                "Sign in to DigitalOcean in your browser. RAILWISE will create a Model Access Key named railwise-oauth-* and load your Inference Routers. Re-run /connect to refresh routers later.",
