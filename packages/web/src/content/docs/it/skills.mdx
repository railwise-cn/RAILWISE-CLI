...
Le skill degli agenti permettono a RAILWISE di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
RAILWISE cerca in queste posizioni:
...
Per i percorsi locali al progetto, RAILWISE risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
RAILWISE elenca le skill disponibili nella descrizione dello strumento `skill`.
