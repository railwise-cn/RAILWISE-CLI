---
title: خوادم LSP
description: يتكامل RAILWISE مع خوادم LSP لديك.
---

يتكامل RAILWISE مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي RAILWISE مع عدة خوادم LSP مدمجة للغات الشائعة:
