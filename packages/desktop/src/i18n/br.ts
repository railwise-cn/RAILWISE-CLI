export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do RAILWISE (甬算)",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do RAILWISE (甬算) foi baixada. Você gostaria de instalá-la e reiniciar?",
