...
import { PartTable, SessionTable } from "@railwise/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@railwise/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".railwise", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@railwise/Session") {}
