---
title: TUI
description: Usando la interfaz de usuario del terminal YONSOON (甬算).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

YONSOON (甬算) proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar YONSOON (甬算) se inicia TUI para el directorio actual.
...
Cuando utilice YONSOON (甬算) TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a YONSOON (甬算). Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de YONSOON (甬算). _Alias_: `/quit`, `/q`
...
Puede personalizar el comportamiento de TUI a través de su archivo de configuración YONSOON (甬算).
