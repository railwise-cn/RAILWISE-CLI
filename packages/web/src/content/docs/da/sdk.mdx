...
Brug den til at bygge integrasjoner og kontrollere railwise programmatisk.
...
Opret en forekomst av railwise:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `railwise.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av railwise, kan du oprete en klientforekomst for at koble til den:
