export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de RAILWISE",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de RAILWISE. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de RAILWISE",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de RAILWISE. Intenta reinstalar la aplicación de escritorio.",
