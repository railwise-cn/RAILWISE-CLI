...
Practical reference for new and migrated Effect code in `packages/railwise`.
...
export namespace Foo {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@railwise/Foo") {}
...
Tool tests should use the existing Effect helpers in `packages/railwise/test/lib/effect.ts`:
