---
title: Compartir
description: Comparte tus conversaciones RAILWISE (甬算).
---

La función para compartir de RAILWISE (甬算) te permite crear enlaces públicos a tus conversaciones de RAILWISE (甬算), para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, RAILWISE (甬算):
...
RAILWISE (甬算) admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, RAILWISE (甬算) usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `railwise.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de railwise en su organización.
