...
Plus de documentation sur la page d'accueil [railwise-gitlab-auth](https://www.npmjs.com/package/@gitlab/railwise-gitlab-auth).
...
{
  "$schema": "https://railwise.ai/config.json",
  "plugin": ["@gitlab/railwise-gitlab-plugin"]
}
```
...
Pour utiliser [Scaleway Generative APIs](https://www.scaleway.com/en/docs/generative-apis/) avec Railwise :
