export const dict = {
  ...
  "desktop.menu.help.documentation": "RAILWISE Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "RAILWISE CLI binary is missing. Try reinstalling the desktop app.",
