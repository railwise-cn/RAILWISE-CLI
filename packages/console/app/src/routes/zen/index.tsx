...
import compareVideo from "../../asset/lander/railwise-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/railwise-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="railwise:auth" content={loggedin() ? "true" : "false"} />
