...
Agent skills omogucavaju RAILWISE da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
RAILWISE pretrazuje ove lokacije:
...
Za projektne lokalne putanje, RAILWISE ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
RAILWISE navodi dostupne skills u opisu `skill` alata.
