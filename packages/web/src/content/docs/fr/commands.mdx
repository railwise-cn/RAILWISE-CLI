...
Vous pouvez ajouter des commandes personnalisées via la configuration RAILWISE ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre RAILWISE [config](/docs/config) :
