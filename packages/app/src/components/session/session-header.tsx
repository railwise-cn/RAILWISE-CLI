...
export function SessionHeader() {
  ...
  const centerMount = createMemo(() => document.getElementById("railwise-titlebar-center"))
  const rightMount = createMemo(() => document.getElementById("railwise-titlebar-right"))
