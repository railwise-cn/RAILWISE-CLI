...
bruker formatet `railwise/<model-id>`. For eksempel, for GPT 5.3 Codex, ville du
brukt `railwise/gpt-5.3-codex` i konfigurasjonen din.
...
- MiMo V2 Pro Free er tilgjengelig på RAILWISE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo V2 Omni Free er tilgjengelig på RAILWISE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
