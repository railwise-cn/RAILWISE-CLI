---
title: خوادم LSP
description: يتكامل YONSOON (甬算) مع خوادم LSP لديك.
---

يتكامل YONSOON (甬算) مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي YONSOON (甬算) مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `YONSOON_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات yonsoon.
