...
1. 在 TUI 中執行 `/connect` 指令，選擇 railwise，然後前往 [railwise.ai/auth](https://railwise.ai/auth)。
...
更多文件請參閱 [railwise-gitlab-auth](https://www.npmjs.com/package/@gitlab/railwise-gitlab-auth) 首頁。
