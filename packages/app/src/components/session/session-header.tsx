import { AppIcon } from "@railwise/ui/app-icon"
...
import { Keybind } from "@railwise/ui/keybind"
...
import { getFilename } from "@railwise/shared/util/path"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_RAILWISE_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("railwise-titlebar-center"))
    setRightMount(document.getElementById("railwise-titlebar-right"))
  })
