...
Mit YONSOON (甬算) kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet YONSOON (甬算) das `yonsoon`-Theme.
...
YONSOON (甬算) liefert mehrere eingebaute Themes mit.
...
- YONSOON (甬算) optisch ans Terminal anpassen wollen
...
YONSOON (甬算) unterstuetzt ein flexibles JSON-basiertes Theme-System.
