...
Les compétences d'agent permettent à RAILWISE de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
RAILWISE recherche ces emplacements :
...
Pour les chemins locaux du projet, RAILWISE remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
RAILWISE répertorie les compétences disponibles dans la description de l'outil `skill`.
