...
RAILWISE (甬算) Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół railwise.

:::note
RAILWISE (甬算) Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca railwise. Logujesz się do RAILWISE (甬算) Zen i dostajesz
...
RAILWISE (甬算) Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

RAILWISE (甬算) Zen działa jak każdy inny dostawca railwise.

1. Logujesz się do **<a href={console}>RAILWISE (甬算) Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz RAILWISE (甬算) Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji railwise
używa formatu `railwise/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `railwise/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie railwise przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na railwise przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie railwise przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w railwise przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
Stworzyliśmy RAILWISE (甬算) Zen, aby:
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z railwise dowolnego innego dostawcy.
