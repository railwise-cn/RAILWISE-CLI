---
title: LSP Server
description: RAILWISE lässt sich in Ihren LSP-Server integrieren.
---

RAILWISE lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

RAILWISE verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn RAILWISE eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer RAILWISE-Konfiguration anpassen.
