...
สร้าง `.yonsoon/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ YONSOON (甬算):
...
- ระดับผู้ใช้ (Global): `~/.config/yonsoon/commands/`
- ระดับโปรเจ็กต์: `.yonsoon/commands/`
...
YONSOON (甬算) มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
