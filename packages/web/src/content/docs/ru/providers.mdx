...
RAILWISE (甬算) Zen — это список моделей, предоставленный командой railwise, которые были
протестировано и проверено на хорошую работу с railwise. [Подробнее](/docs/zen).

:::tip
Если вы новичок, мы рекомендуем начать с RAILWISE (甬算) Zen.
:::
...
2. Выберите метод аутентификации:
   ...
   3. Имя: `RAILWISE (甬算)`, Области применения: `api`
...
RAILWISE (甬算) Zen — это список протестированных и проверенных моделей, предоставленный командой railwise. [Подробнее](/docs/zen).

1. Войдите в систему **<a href={console}>RAILWISE (甬算) Zen</a>** и нажмите **Создать ключ API**.

2. Запустите команду `/connect` и найдите **RAILWISE (甬算) Zen**.
