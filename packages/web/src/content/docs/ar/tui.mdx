---
title: TUI
description: استخدام واجهة المستخدم TUI في RAILWISE.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر RAILWISE واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل RAILWISE إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة RAILWISE في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى RAILWISE. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من RAILWISE. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `railwise.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار RAILWISE بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `railwise.default`.
