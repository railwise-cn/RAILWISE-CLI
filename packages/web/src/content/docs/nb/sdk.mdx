---
title: SDK
description: Typesikker JS-klient for RAILWISE-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

RAILWISE JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere RAILWISE programmatisk.
...
Opprett en forekomst av RAILWISE:
...
Hvis du allerede har en kjørende forekomst av RAILWISE, kan du opprette en klientforekomst for å koble til den:
