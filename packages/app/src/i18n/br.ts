export const dict = {
  ...
  "dialog.provider.railwise.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.railwise.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.railwiseGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo RAILWISE",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no RAILWISE.",
  ...
  "provider.connect.railwiseZen.line1":
    "RAILWISE Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.railwiseZen.visit.prefix": "Visite ",
  "provider.connect.railwiseZen.visit.link": "railwise.ai/zen",
  "provider.connect.railwiseZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no RAILWISE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no RAILWISE.",
  ...
  "dialog.plugins.empty": "Plugins configurados em railwise.json",
  ...
  "dialog.server.description": "Trocar para qual servidor RAILWISE este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do RAILWISE ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do RAILWISE",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (railwise.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: RAILWISE ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "RAILWISE inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor RAILWISE dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do RAILWISE",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o RAILWISE aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o RAILWISE segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o RAILWISE é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o RAILWISE iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do RAILWISE.",
