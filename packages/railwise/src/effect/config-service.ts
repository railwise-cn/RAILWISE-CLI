 ...
 *   "@railwise/ServerAuthConfig",
 *   {
 *     password: Config.string("RAILWISE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("RAILWISE_SERVER_USERNAME").pipe(Config.withDefault("railwise")),
 *   },
 * ) {}
 *
