export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji RAILWISE",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} RAILWISE. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja RAILWISE",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego RAILWISE CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
