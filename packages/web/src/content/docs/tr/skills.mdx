...
Ajan becerileri, railwise'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
railwise su konumlari tarar:

- Proje konfigurasyonu: `.railwise/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/railwise/skills/<name>/SKILL.md`
...
Proje yerel yollarinda railwise, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.railwise/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/railwise/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.railwise/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
railwise, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`railwise.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`railwise.json` icinde):
