...
- `client`: Yapay zeka ile etkileşime geçmek için railwise'lu bir SDK istemcisi.
...
Seviyeler: `debug`, `info`, `warn`, `error`. Ayrıntılar için [SDK documentation](https://railwise.ai/docs/sdk)'e bakın.
