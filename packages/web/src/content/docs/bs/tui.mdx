---
title: TUI
description: Korištenje korisničkog interfejsa RAILWISE terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

RAILWISE pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje RAILWISE pokreće TUI za trenutni direktorij.
...
Kada koristite RAILWISE TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u RAILWISE. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz RAILWISE. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `railwise.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo RAILWISE čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `railwise.default`.
