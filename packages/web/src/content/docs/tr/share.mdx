---
title: Paylasim
description: yonsoon konusmalarini genel baglantilarla paylasin.
---

yonsoon'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda yonsoon:
...
yonsoon, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak yonsoon manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `yonsoon.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda yonsoon kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
