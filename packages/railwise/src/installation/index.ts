...
export namespace Installation {
  ...
  export const USER_AGENT = `opencode/${CHANNEL}/${VERSION}/${Flag.RAILWISE_CLIENT}`
    ...
    Layer.effect(
      ...
      Effect.gen(function* () {
        ...
        const getBrewFormula = Effect.fnUntraced(function* () {
          ...
          if (tapFormula.includes("railwise")) return "anomalyco/tap/opencode"
          const coreFormula = yield* text(["brew", "list", "--formula", "opencode"])
          if (coreFormula.includes("railwise")) return "opencode"
          return "opencode"
        })
