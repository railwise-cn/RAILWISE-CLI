...
1. Uruchom polecenie `/connect` w TUI, wybierz railwise i przejdź do [railwise.ai/auth](https://railwise.ai/auth).
...
Więcej informacji znajdziesz na stronie [railwise-gitlab-auth](https://www.npmjs.com/package/@gitlab/railwise-gitlab-auth).
