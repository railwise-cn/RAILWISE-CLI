    ...
    () =>
      ...
      app
        ...
        .use((c, next) => {
          ...
          const password = Flag.YONSOON_SERVER_PASSWORD
          if (!password) return next()
          const username = Flag.YONSOON_SERVER_USERNAME ?? "yonsoon"
        ...
        .use(async (c, next) => {
          ...
          const raw = c.req.query("directory") || c.req.header("x-yonsoon-directory") || process.cwd()
          const directory = (() => {
            try {
        ...
        .all("/*", async (c) => {
          ...
          const response = await proxy(`https://app.yonsoon.ai${path}`, {
            ...c.req,
            headers: {
              ...c.req.raw.headers,
              host: "app.yonsoon.ai",
