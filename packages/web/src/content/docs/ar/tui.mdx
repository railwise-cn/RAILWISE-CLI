---
title: TUI
description: استخدام واجهة المستخدم TUI في YONSOON (甬算).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر YONSOON (甬算) واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل YONSOON (甬算) إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة YONSOON (甬算) في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى YONSOON (甬算). يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من YONSOON (甬算). _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات YONSOON (甬算).
