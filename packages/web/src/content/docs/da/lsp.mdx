---
title: LSP-servere
description: YONSOON (甬算) integreres med dine LSP-servere.
---

YONSOON (甬算) integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

YONSOON (甬算) leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `YONSOON_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når yonsoon åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din yonsoon-konfiguration.
