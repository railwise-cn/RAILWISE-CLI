...
Desktop application and browser-based app issues, including `railwise web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core railwise server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

RAILWISE Zen, RAILWISE Go, and billing issues.
