...
declare module "virtual:railwise-server" {
  ...
  export namespace Database {
    export const getPath: typeof import("../../../railwise/dist/types/src/node").Database.getPath
    export const Client: typeof import("../../../railwise/dist/types/src/node").Database.Client
  }
  export namespace JsonMigration {
    export type Progress = import("../../../railwise/dist/types/src/node").JsonMigration.Progress
    export const run: typeof import("../../../railwise/dist/types/src/node").JsonMigration.run
  }
