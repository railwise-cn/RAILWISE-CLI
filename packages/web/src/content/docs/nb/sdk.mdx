---
title: SDK
description: Typesikker JS-klient for YONSOON (甬算)-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

YONSOON (甬算) JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere YONSOON (甬算) programmatisk.
...
Opprett en forekomst av YONSOON (甬算):
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `yonsoon.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av YONSOON (甬算), kan du opprette en klientforekomst for å koble til den:
