---
title: LSP-servere
description: RAILWISE (甬算) integreres med dine LSP-servere.
---

RAILWISE (甬算) integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

RAILWISE (甬算) leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `RAILWISE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når railwise åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din railwise-konfiguration.
