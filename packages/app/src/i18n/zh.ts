...
export const dict = {
  ...
  "dialog.provider.railwise.note": "使用 RAILWISE Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "RAILWISE 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 RAILWISE 中使用 {{provider}} 模型。",
  ...
  "provider.connect.railwiseZen.line1": "RAILWISE Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.railwiseZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.railwiseZen.visit.prefix": "访问 ",
  "provider.connect.railwiseZen.visit.link": "railwise.ai/zen",
  "provider.connect.railwiseZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 RAILWISE 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 RAILWISE 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 railwise.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 RAILWISE 服务器。",
  ...
  "toast.update.description": "RAILWISE 有新版本 ({{version}}) 可安装。",
  ...
  "error.chain.checkConfig": "请检查你的配置 (railwise.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: RAILWISE 暂不支持 MCP 认证。',
  ...
  "session.side.agent": "协作",
  "session.side.model": "模型",
  "session.side.progress": "会话",
  "session.side.context": "上下文",
  "session.side.project.empty": "未命名",
  "session.side.agent.empty": "未分配",
  "session.side.model.empty": "未接入模型",
  "session.side.progress.ready": "准备开始",
  "session.side.progress.loading": "载入中",
  "session.side.progress.waiting": "等待输入",
  "session.side.progress.turns": "{{count}} 轮",
  "session.side.context.pending": "进入会话",
  "session.side.context.empty": "暂无用量",
  "session.side.context.percent": "{{percent}}%",
  "session.side.runtime.title": "执行",
  "session.side.runtime.blockers": "待处理",
  "session.side.runtime.blockers.ready": "就绪",
  "session.side.runtime.blockers.none": "无阻塞",
  "session.side.runtime.blockers.pending": "{{count}} 项待处理",
  "session.side.runtime.todos": "待办",
  "session.side.runtime.todos.ready": "就绪",
  "session.side.runtime.todos.empty": "暂无待办",
  "session.side.runtime.todos.progress": "{{done}}/{{total}} 完成",
  "session.side.runtime.capabilities": "能力",
  "session.side.runtime.capabilities.ready": "就绪",
  "session.side.runtime.capabilities.empty": "暂无能力",
  "session.side.runtime.capabilities.count": "{{count}} 项能力",
  "session.side.runtime.tools": "工具",
  "session.side.runtime.tools.empty": "暂无调用",
  "session.side.runtime.tools.running": "{{count}} 个运行中",
  "session.side.runtime.tools.error": "{{count}} 个错误",
  "session.side.runtime.tools.done": "{{done}}/{{total}} 完成",
  "session.side.runtime.tool.pending": "待确认",
  "session.side.runtime.tool.running": "运行中",
  "session.side.runtime.tool.completed": "完成",
  "session.side.runtime.tool.error": "错误",
  "session.side.runtime.tool.runningSummary": "工具正在执行，等待结果返回。",
  "session.side.runtime.state.ready": "就绪",
  "session.side.runtime.state.loading": "载入",
  "session.side.runtime.state.busy": "运行中",
  "session.side.runtime.state.blocked": "阻塞",
  "session.side.runtime.state.retry": "重试 {{attempt}}",
  "session.side.runtime.state.idle": "空闲",
  "session.side.runtime.chain.title": "执行链路",
  "session.side.runtime.chain.model": "模型",
  "session.side.runtime.chain.agent": "协作",
  "session.side.runtime.chain.capabilities": "能力",
  "session.side.runtime.chain.tools": "工具",
  "session.side.runtime.chain.next": "下一步",
  "session.side.runtime.chain.next.ready": "准备开始",
  "session.side.runtime.chain.next.waiting": "等待下一轮输入",
  "session.side.runtime.chain.status.done": "就绪",
  "session.side.runtime.chain.status.running": "进行中",
  "session.side.runtime.chain.status.blocked": "需处理",
  "session.side.runtime.chain.status.waiting": "等待",
  "session.side.runtime.chain.status.error": "错误",
  "session.side.runtime.chain.action.connectModel": "接入",
  "session.side.runtime.chain.action.switchModel": "更换",
  "session.side.runtime.chain.action.configure": "配置",
  "session.side.runtime.chain.action.view": "查看",
  "session.side.runtime.chain.action.repair": "修复",
  "session.side.runtime.chain.action.handle": "处理",
  "session.side.runtime.chain.action.focus": "定位",
  "session.side.runtime.chain.action.input": "输入",
  "session.execution.title": "执行证据",
  "session.execution.agent.empty": "未分配智能体",
  "session.execution.agent.more": "{{agents}} 等 {{count}} 个",
  "session.execution.capabilities": "能力",
  "session.execution.tools.none": "未调用工具",
  "session.execution.tools.running": "{{count}} 个运行中",
  "session.execution.tools.error": "{{count}} 个错误",
  "session.execution.tools.done": "{{done}}/{{total}} 完成",
  "session.execution.tool.pending": "待确认",
  "session.execution.tool.running": "运行中",
  "session.execution.tool.completed": "完成",
  "session.execution.tool.error": "错误",
  "session.execution.tool.runningSummary": "工具正在执行，等待结果返回。",
  ...
  "session.new.project.label": "项目",
  "session.new.project.ready": "准备开始协作",
  "session.new.project.untitled": "未命名项目",
  "session.new.branch.label": "分支",
  "session.new.lastModified": "最后修改",
  "session.new.lastModified.empty": "尚未开始",
  ...
  "sidebar.gettingStarted.line1": "RAILWISE 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.appearance.description": "自定义 RAILWISE 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 RAILWISE 的主题。",
  ...
  "settings.updates.row.startup.description": "在 RAILWISE 启动时自动检查更新",
