...
// railwise and the HTTP event stream still expect legacy bus/sync payloads.
...
import "@railwise/core/catalog"
import "@railwise/core/session-event"
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@railwise/EventV2Bridge") {}
