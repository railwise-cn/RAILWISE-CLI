...
Las habilidades del agente permiten a RAILWISE descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
RAILWISE busca estas ubicaciones:
...
Para las rutas locales del proyecto, RAILWISE sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
RAILWISE enumera las habilidades disponibles en la descripción de la herramienta `skill`.
