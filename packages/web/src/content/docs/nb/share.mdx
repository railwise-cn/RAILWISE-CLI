...
Delingsfunksjonen i RAILWISE lar deg lage offentlige lenker til dine RAILWISE-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Som standard bruker RAILWISE manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
