---
title: TUI
description: Usando la interfaz de usuario del terminal RAILWISE (甬算).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

RAILWISE (甬算) proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar RAILWISE (甬算) se inicia TUI para el directorio actual.
...
Cuando utilice RAILWISE (甬算) TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a RAILWISE (甬算). Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de RAILWISE (甬算). _Alias_: `/quit`, `/q`
...
Puede personalizar el comportamiento de TUI a través de su archivo de configuración RAILWISE (甬算).
