---
title: TUI
description: Brug af RAILWISE-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

RAILWISE giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre RAILWISE starter TUI for den nuværende mappe.
...
Når du bruger RAILWISE TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til RAILWISE. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut RAILWISE. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `railwise.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe RAILWISE venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `railwise.default`.
