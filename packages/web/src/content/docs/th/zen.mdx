---
title: เซน
description: รายการโมเดลที่คัดสรรโดย RAILWISE (甬算)
---
...
RAILWISE (甬算) Zen คือรายการโมเดลที่ได้รับการทดสอบและตรวจสอบแล้วโดยทีมงาน RAILWISE (甬算)

:::note
RAILWISE (甬算) Zen ปัจจุบันอยู่ในช่วงเบต้า
:::

Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน RAILWISE (甬算) คุณเข้าสู่ระบบ RAILWISE (甬算) Zen และรับ
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่เลือกซึ่งทำงานได้ดีกับ RAILWISE (甬算)
:::
...
RAILWISE (甬算) Zen เป็นเกตเวย์ AI ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## มันทำงานอย่างไร

RAILWISE (甬算) Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน RAILWISE (甬算)

1. คุณลงชื่อเข้าใช้ **<a href={console}>RAILWISE (甬算) Zen</a>** เพิ่มการเรียกเก็บเงินของคุณ
   รายละเอียดและคัดลอกรหัส API ของคุณ
2. คุณรันคำสั่ง `/connect` ใน TUI เลือก RAILWISE (甬算) Zen และวางคีย์ API ของคุณ
...
| Claude Haiku 3.5   | claude-haiku-3-5   | `https://railwise.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
[model id](/docs/config/#models) ในการกำหนดค่า RAILWISE (甬算) ของคุณ
ใช้รูปแบบ `railwise/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.2 Codex คุณจะต้อง
ใช้ `railwise/gpt-5.2-codex` ในการกำหนดค่าของคุณ
...
- GLM 4.7 ใช้งานได้ฟรีบน RAILWISE (甬算) ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Kimi K2.5 Free พร้อมใช้งานบน RAILWISE (甬算) ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- MiniMax M2.1 Free พร้อมใช้งานบน RAILWISE (甬算) ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Big Pickle เป็นโมเดลล่องหนที่ให้บริการฟรีบน RAILWISE (甬算) ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
...
เราสร้าง RAILWISE (甬算) Zen เพื่อ:
...
4. **ไม่มีการล็อคอิน** โดยอนุญาตให้คุณใช้กับเอเจนต์การเขียนโค้ดอื่นๆ และให้คุณใช้ผู้ให้บริการรายอื่นกับ RAILWISE (甬算) ได้เช่นกัน
