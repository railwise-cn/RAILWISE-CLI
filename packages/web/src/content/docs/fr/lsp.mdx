---
title: Serveurs LSP
description: RAILWISE s'intègre à vos serveurs LSP.
---

RAILWISE s'intègre via le protocole LSP (Language Server Protocol) pour aider le LLM à interagir avec votre base de code. Il utilise des diagnostics pour fournir des commentaires au LLM.

---

## Serveurs intégrés

RAILWISE est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
