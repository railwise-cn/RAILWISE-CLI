export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'RAILWISE",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'RAILWISE a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'RAILWISE",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI RAILWISE est manquant. Essayez de réinstaller l'application de bureau.",
