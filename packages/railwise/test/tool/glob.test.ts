  ...
  references.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "railwise-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "railwise-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "railwise-glob-reference/repo",
        },
      },
    },
  )
