...
import type * as SDK from "@railwise/sdk/v2"
...
import { SessionShareTable } from "@railwise/core/share/sql"
...
const disabled = process.env["RAILWISE_DISABLE_SHARE"] === "true" || process.env["RAILWISE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@railwise/ShareNext") {}
