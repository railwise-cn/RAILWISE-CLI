---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala railwise.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

railwise zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie railwise uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI railwise, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do railwise. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij railwise. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `railwise.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo RAILWISE czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `railwise.default`.
