...
Die [Modell-ID](/docs/config/#models) in deiner RAILWISE Config verwendet das Format `railwise-go/<model-id>`. Für Kimi K2.5 würdest du beispielsweise `railwise-go/kimi-k2.5` in deiner Config verwenden.
