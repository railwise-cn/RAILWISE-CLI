...
export const dict = {
  ...
  "dialog.provider.railwise.tagline": "可靠的优化模型",
  "dialog.provider.railwiseGo.tagline": "适合所有人的低成本订阅",
  ...
  "settings.general.row.colorScheme.description": "选择 RAILWISE 跟随系统、浅色或深色主题",
