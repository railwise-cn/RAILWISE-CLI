...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      const railwiseProjectID = input.model.providerID.startsWith("railwise")
      ...
      return streamText({
        ...
        abortSignal: input.abort,
        headers: {
          ...(input.model.providerID.startsWith("railwise")
            ? {
                "x-railwise-project": railwiseProjectID,
                "x-railwise-session": input.sessionID,
                "x-railwise-request": input.user.id,
                "x-railwise-client": flags.client,
