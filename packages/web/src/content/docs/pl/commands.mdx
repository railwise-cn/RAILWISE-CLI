...
Utwórz `.yonsoon/commands/test.md`:
...
Możesz zdefiniować polecenia w `yonsoon.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji yonsoon:
...
- Globalnie: `~/.config/yonsoon/commands/`
- Na projekt: `.yonsoon/commands/`
...
yonsoon zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
