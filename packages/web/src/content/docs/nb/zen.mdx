...
:::note
RAILWISE Zen er for øyeblikket i beta.
:::
...
- MiniMax M2.5 Free er tilgjengelig på RAILWISE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ring 2.6 1T Free er tilgjengelig på RAILWISE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på RAILWISE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
- Ring 2.6 1T Free: I gratisperioden kan innsamlede data brukes til å forbedre modellen.
