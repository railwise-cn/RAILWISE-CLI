...
مع RAILWISE يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم RAILWISE سمتنا `railwise`.
...
يأتي RAILWISE مع عدة سمات مدمجة.
...
- يريدون أن يطابق RAILWISE مظهر terminal لديهم
...
يدعم RAILWISE نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
