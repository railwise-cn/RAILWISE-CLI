...
>()("@railwise/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@railwise/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.RAILWISE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.RAILWISE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-railwise-directory"] || process.cwd()
}
