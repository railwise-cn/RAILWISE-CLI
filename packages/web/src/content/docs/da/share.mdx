---
title: Deling
description: Del dine RAILWISE-samtaler.
---

RAILWISEs delingsfunksjon lar deg lage offentlige lenker til dine RAILWISE-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, RAILWISE:
...
RAILWISE støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger RAILWISE manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
