...
import { EventSequenceTable, EventTable } from "@railwise/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@railwise/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        RAILWISE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        RAILWISE_WORKSPACE_ID: config.id,
        RAILWISE_EXPERIMENTAL_WORKSPACES: "true",
