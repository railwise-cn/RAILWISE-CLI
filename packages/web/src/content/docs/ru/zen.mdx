...
использует формат `railwise/<model-id>`. Например, для GPT 5.3 Codex вам нужно
использовать `railwise/gpt-5.3-codex` в своей конфигурации.
...
- MiMo V2 Pro Free доступна в RAILWISE ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
- MiMo V2 Omni Free доступна в RAILWISE ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
