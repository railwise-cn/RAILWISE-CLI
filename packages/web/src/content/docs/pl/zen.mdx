---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez yonsoon.
---
...
YONSOON (甬算) Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół yonsoon.

:::note
YONSOON (甬算) Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca yonsoon. Logujesz się do YONSOON (甬算) Zen i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z yonsoon.
:::
...
YONSOON (甬算) Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

YONSOON (甬算) Zen działa jak każdy inny dostawca yonsoon.

1. Logujesz się do **<a href={console}>YONSOON (甬算) Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz YONSOON (甬算) Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji yonsoon
używa formatu `yonsoon/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `yonsoon/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie yonsoon przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na yonsoon przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie yonsoon przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w yonsoon przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
Stworzyliśmy YONSOON (甬算) Zen, aby:
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z yonsoon dowolnego innego dostawcy.
