export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do RAILWISE",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do RAILWISE foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do RAILWISE",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do RAILWISE está ausente. Tente reinstalar o aplicativo de desktop.",
