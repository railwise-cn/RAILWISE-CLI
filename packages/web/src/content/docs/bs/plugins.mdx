---
title: Dodaci
description: Napišite vlastite dodatke za proširenje RAILWISE.
---

Dodaci vam omogućavaju da proširite RAILWISE spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja RAILWISE.
...
RAILWISE pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje RAILWISE.
...
:::note
Ako koristite desktop aplikaciju RAILWISE, ona može automatski slati sistemske obavijesti kada je odgovor spreman ili kada dođe do greške u sesiji.
:::
