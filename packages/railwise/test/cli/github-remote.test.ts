...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/railwise.git")).toEqual({ owner: "sst", repo: "railwise" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/railwise")).toEqual({ owner: "sst", repo: "railwise" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/railwise.git")).toEqual({ owner: "sst", repo: "railwise" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/railwise")).toEqual({ owner: "sst", repo: "railwise" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/railwise.git")).toEqual({ owner: "sst", repo: "railwise" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/railwise")).toEqual({ owner: "sst", repo: "railwise" })
})
