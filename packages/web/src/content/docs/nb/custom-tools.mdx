...
description: Lag verktøy som LLM kan kalle inn RAILWISE (甬算).
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med RAILWISE (甬算) sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
