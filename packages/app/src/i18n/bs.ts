export const dict = {
  ...
  "dialog.provider.railwise.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.railwise.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.railwiseGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje RAILWISE",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u RAILWISE-u.",
  ...
  "provider.connect.railwiseZen.line1":
    "RAILWISE Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.railwiseZen.visit.prefix": "Posjeti ",
  "provider.connect.railwiseZen.visit.link": "railwise.ai/zen",
  "provider.connect.railwiseZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u RAILWISE-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u RAILWISE-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u railwise.json",
  ...
  "dialog.server.description": "Promijeni na koji se RAILWISE server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija RAILWISE-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (railwise.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: RAILWISE još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "RAILWISE uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u RAILWISE-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako RAILWISE izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li RAILWISE prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu RAILWISE-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se RAILWISE pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju RAILWISE-a.",
