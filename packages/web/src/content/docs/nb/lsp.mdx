...
RAILWISE kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.
...
Når LSP er aktivert og railwise åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i RAILWISE-konfigurasjonen.
