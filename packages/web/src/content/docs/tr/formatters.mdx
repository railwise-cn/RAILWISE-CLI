...
description: railwise dile özgü biçimlendiriciler kullanır.
---

railwise, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

railwise, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, railwise bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

railwise bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri railwise yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
