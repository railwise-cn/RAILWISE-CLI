...
تتيح مهارات الوكيل لـ RAILWISE اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج RAILWISE صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض RAILWISE المهارات المتاحة في وصف أداة `skill`.
