...
Zen fungerer som alle andre leverandører i RAILWISE. Du logger på RAILWISE Zen og får
...
RAILWISE Zen fungerer som alle andre leverandører i RAILWISE.

1. Du logger på **<a href={console}>RAILWISE Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger RAILWISE Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i RAILWISE-konfigurasjonen
...
- GLM 4.7 Free er tilgjengelig på RAILWISE i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Kimi K2.5 Free er tilgjengelig på RAILWISE i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- MiniMax M2.1 Free er tilgjengelig på RAILWISE i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på RAILWISE i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
