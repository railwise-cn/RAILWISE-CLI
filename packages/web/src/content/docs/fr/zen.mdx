...
:::note
RAILWISE Zen est actuellement en version bêta.
:::
...
| Qwen3.6 Plus           | qwen3.6-plus           | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3.5 Plus           | qwen3.5-plus           | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5           | minimax-m2.5           | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5 Free      | minimax-m2.5-free      | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Ring 2.6 1T            | ring-2.6-1t-free       | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free  | nemotron-3-super-free  | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
- MiniMax M2.5 Free est disponible sur RAILWISE pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Ring 2.6 1T Free est disponible sur RAILWISE pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Super Free est disponible sur RAILWISE pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
- Ring 2.6 1T Free : Pendant sa période gratuite, les données collectées peuvent être utilisées pour améliorer le modèle.
