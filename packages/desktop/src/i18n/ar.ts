export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من RAILWISE (甬算)",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من RAILWISE (甬算)، هل ترغب في تثبيته وإعادة تشغيله؟",
