export * as RAILWISE from "./railwise"
...
/** Intentional public native API for Effect applications embedding RAILWISE. */
export class Service extends Context.Service<Service, Interface>()("@railwise/public/RAILWISE") {}
...
>()("@railwise/public/RAILWISE/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("RAILWISE.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("RAILWISE.sessions.switchModel")(function* (input) {
...
// TODO: Add RAILWISE.create(...) as the Promise facade over the same native API semantics.
