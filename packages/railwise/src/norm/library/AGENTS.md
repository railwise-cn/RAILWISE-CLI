...
`tool_norm_diff` compares two norm/version scopes, aligns pages by clause id, and persists reviewable reports as `wiki/changes/diff-<from>-to-<to>-YYYY-MM-DD.md`.
