...
RAILWISE kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.
...
Når LSP er aktiveret, og railwise åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din railwise-konfiguration.
