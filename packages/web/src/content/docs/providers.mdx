...
1. Run the `/connect` command in the TUI, select railwise, and head to [railwise.ai/auth](https://railwise.ai/auth).
...
More documentation on [railwise-gitlab-auth](https://www.npmjs.com/package/@gitlab/railwise-gitlab-auth) homepage.
...
To use [Scaleway Generative APIs](https://www.scaleway.com/en/docs/generative-apis/) with RAILWISE:
