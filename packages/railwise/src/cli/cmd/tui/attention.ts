...
import defaultSoundPath from "@railwise/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@railwise/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@railwise/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@railwise/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@railwise/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@railwise/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "railwise"
const DEFAULT_PACK_ID = "railwise.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "RAILWISE Default",
  builtin: true,
  sounds: {
