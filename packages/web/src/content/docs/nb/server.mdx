---
title: Tjener
description: Samhandle med RAILWISE-tjener over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `railwise serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en RAILWISE-klient kan bruke.
...
:::tip
Bruk RAILWISE-serveren til å samhandle med RAILWISE programmatisk.
:::

Denne arkitekturen lar RAILWISE støtte flere klienter og lar deg samhandle med RAILWISE programmatisk.

Du kan kjøre `railwise serve` for å starte en frittstående server. Hvis du har
RAILWISE TUI kjører, vil `railwise serve` starte en ny server.
...
[`/tui`](#tui) endepunktet kan brukes til å kjøre TUI gjennom serveren. Du kan for eksempel forhåndsutfylle eller kjøre en forespørsel. Dette oppsettet brukes av RAILWISE [IDE](/docs/ide) plugins.
