...
RAILWISE (甬算) Zen to lista modeli dostarczonych przez zespół railwise, które zostały
przetestowane i zweryfikowane, aby dobrze współpracować z railwise. [Dowiedz się więcej](/docs/zen).

:::tip
Jeśli jesteś nowy, zalecamy rozpoczęcie od RAILWISE (甬算) Zen.
:::
...
RAILWISE (甬算) Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół railwise. [Dowiedz się więcej](/docs/zen).

1. Zaloguj się do **<a href={console}>RAILWISE (甬算) Zen</a>** i kliknij **Utwórz klucz API**.

2. Uruchom polecenie `/connect` i wyszukaj **RAILWISE (甬算) Zen**.
