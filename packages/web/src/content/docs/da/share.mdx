---
title: Deling
description: Del dine YONSOON (甬算)-samtaler.
---

YONSOON (甬算)s delingsfunksjon lar deg lage offentlige lenker til dine YONSOON (甬算)-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, YONSOON (甬算):
...
YONSOON (甬算) støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger YONSOON (甬算) manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `yonsoon.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av yonsoon i organisasjonen din.
