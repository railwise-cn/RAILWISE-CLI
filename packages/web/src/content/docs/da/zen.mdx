...
Zen fungerer som alle andre udbydere i RAILWISE. Du logger på RAILWISE Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med RAILWISE.
:::
...
RAILWISE Zen fungerer som alle andre udbydere i RAILWISE.

1. Du logger på **<a href={console}>RAILWISE Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger RAILWISE Zen og indsætter API-nøglen.
...
[model-id](/docs/config/#models) i RAILWISE-konfigurationen
...
- GLM 4.7 Gratis er tilgængelig på RAILWISE i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på RAILWISE i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- MiniMax M2.1 Gratis er tilgængelig på RAILWISE i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på RAILWISE i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede RAILWISE Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med RAILWISE også.
