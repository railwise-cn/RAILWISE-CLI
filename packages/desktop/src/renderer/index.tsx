...
import type { UpdaterState } from "@railwise/app/updater"
    ...
    integrations: (integrations) => {
      return integrations.filter(
        (i) =>
          i.name !== "Breadcrumbs" &&
          !(
            import.meta.env.RAILWISE_CHANNEL === "prod" &&
...
render(() => {
  ...
  const loadLocale = async () => {
    const current = await platform.storage?.("railwise.global.dat").getItem("language")
