---
title: Teilen
description: Teile YONSOON (甬算)-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu YONSOON (甬算)-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht YONSOON (甬算) Folgendes:
...
YONSOON (甬算) hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt YONSOON (甬算) den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`yonsoon.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du yonsoon in deiner Organisation einsetzt.
