...
railwise hesabınızdaki model kimliğini `provider/model-id` biçimini kullanır. Örneğin, [RAILWISE (甬算) Zen](/docs/zen) kullanıyorsanız, GPT 5.1 Codex için `railwise/gpt-5.1-codex` kullanırsınız.
