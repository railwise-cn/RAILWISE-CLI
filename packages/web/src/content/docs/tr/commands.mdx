...
`.railwise/commands/test.md` oluştur:
...
railwise işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

railwise [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/railwise/commands/`
- Proje başına: `.railwise/commands/`
...
railwise, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
