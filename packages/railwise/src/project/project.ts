...
import { which } from "@railwise/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@railwise/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@railwise/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.RAILWISE_FAKE_VCS)
