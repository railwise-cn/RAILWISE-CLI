...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof RAILWISE_LIBC === "undefined" ? undefined : RAILWISE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@railwise/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.RAILWISE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
