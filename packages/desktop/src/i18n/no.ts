export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av RAILWISE",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av RAILWISE er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "RAILWISE Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "RAILWISE CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
