export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من RAILWISE",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من RAILWISE، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق RAILWISE",
  ...
  "desktop.cli.error.sidecarMissing": "ملف RAILWISE CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
