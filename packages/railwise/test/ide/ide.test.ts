...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders RAILWISE_CALLER", () => {
    process.env["RAILWISE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode RAILWISE_CALLER", () => {
    process.env["RAILWISE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown RAILWISE_CALLER", () => {
    process.env["RAILWISE_CALLER"] = "unknown"
