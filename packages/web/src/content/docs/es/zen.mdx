---
title: Zen
description: Lista seleccionada de modelos proporcionada por YONSOON (甬算).
---
...
YONSOON (甬算) Zen es una lista de modelos probados y verificados proporcionada por el equipo YONSOON (甬算).

:::note
YONSOON (甬算) Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en YONSOON (甬算). Inicias sesion en YONSOON (甬算) Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar YONSOON (甬算).
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con YONSOON (甬算).
:::
...
YONSOON (甬算) Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

YONSOON (甬算) Zen funciona como cualquier otro proveedor en YONSOON (甬算).

1. Inicias sesión en **<a href={console}>YONSOON (甬算) Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona YONSOON (甬算) Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de YONSOON (甬算)
usa el formato `yonsoon/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `yonsoon/gpt-5.2-codex` en tu configuracion.
...
- GLM 4.7 Free está disponible en YONSOON (甬算) por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Kimi K2.5 Free está disponible en YONSOON (甬算) por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- MiniMax M2.1 Free está disponible en YONSOON (甬算) por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en YONSOON (甬算) por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con YONSOON (甬算) también.
