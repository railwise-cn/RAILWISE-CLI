---
title: Condivisione
description: Condividi le tue conversazioni RAILWISE (甬算).
---

La funzione di condivisione di RAILWISE (甬算) ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, RAILWISE (甬算):
...
RAILWISE (甬算) supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, RAILWISE (甬算) usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `railwise.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare railwise nella tua organizzazione.
