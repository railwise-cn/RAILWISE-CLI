export const dict = {
  ...
  "dialog.provider.railwise.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.railwise.tagline": "Modèles optimisés et fiables",
  "dialog.provider.railwiseGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par RAILWISE",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans RAILWISE.",
  ...
  "provider.connect.railwiseZen.line1":
    "RAILWISE Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.railwiseZen.visit.prefix": "Visitez ",
  "provider.connect.railwiseZen.visit.link": "railwise.ai/zen",
  "provider.connect.railwiseZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans RAILWISE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans RAILWISE.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans railwise.json",
  ...
  "dialog.server.description": "Changez le serveur RAILWISE auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'RAILWISE ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe RAILWISE",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (railwise.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'RAILWISE ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "RAILWISE inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur RAILWISE dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour RAILWISE",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'RAILWISE sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si RAILWISE suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'RAILWISE.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'RAILWISE",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'RAILWISE.",
