...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips railwise-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-railwise-directory"]).toBeUndefined()
      expect(forwarded["x-railwise-workspace"]).toBeUndefined()
