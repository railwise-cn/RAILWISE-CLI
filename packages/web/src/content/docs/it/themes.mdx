...
Con RAILWISE puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, RAILWISE usa il tema `railwise`.
...
RAILWISE include diversi temi integrati.
...
- Vuole che RAILWISE corrisponda all'aspetto del terminale
...
RAILWISE supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
