...
- PR #15835: https://github.com/anomalyco/railwise/pull/15835

## Do Not Translate (Locale Additions)

- `RAILWISE` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `railwise` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `RAILWISE` in prose, `railwise` only for exact technical identifiers
...
- Avoid changing `railwise` to `RAILWISE` inside commands, URLs, package names, or code literals
