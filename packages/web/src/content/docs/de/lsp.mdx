...
RAILWISE kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.
...
Wenn LSP aktiviert ist und RAILWISE eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer RAILWISE-Konfiguration aktivieren und anpassen.
