...
RAILWISE (甬算) Zen é uma lista de modelos fornecidos pela equipe do railwise que foram testados e verificados para funcionar bem com o railwise. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o RAILWISE (甬算) Zen.
:::
...
2. Escolha seu método de autenticação:
   ...
   3. Nome: `RAILWISE (甬算)`, Escopos: `api`
...
RAILWISE (甬算) Zen é uma lista de modelos testados e verificados fornecidos pela equipe do railwise. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>RAILWISE (甬算) Zen</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **RAILWISE (甬算) Zen**.
