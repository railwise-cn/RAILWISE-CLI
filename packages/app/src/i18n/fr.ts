export const dict = {
  ...
  "dialog.provider.yonsoon.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par YONSOON (甬算)",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans YONSOON (甬算).",
  ...
  "provider.connect.yonsoonZen.line1":
    "YONSOON (甬算) Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.yonsoonZen.visit.prefix": "Visitez ",
  "provider.connect.yonsoonZen.visit.link": "yonsoon.ai/zen",
  "provider.connect.yonsoonZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans YONSOON (甬算).",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans YONSOON (甬算).",
  ...
  "dialog.plugins.empty": "Plugins configurés dans yonsoon.json",
  ...
  "dialog.server.description": "Changez le serveur YONSOON (甬算) auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'YONSOON (甬算) ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe YONSOON (甬算)",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (yonsoon.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'YONSOON (甬算) ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "YONSOON (甬算) inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur YONSOON (甬算) dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour YONSOON (甬算)",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'YONSOON (甬算) sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'YONSOON (甬算).",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'YONSOON (甬算)",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'YONSOON (甬算).",
