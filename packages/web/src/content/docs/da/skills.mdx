...
Agentferdigheter lar RAILWISE oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går RAILWISE opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
RAILWISE viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
