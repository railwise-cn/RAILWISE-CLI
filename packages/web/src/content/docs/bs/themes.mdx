...
U RAILWISE mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, RAILWISE koristi nasu `railwise` temu.
...
RAILWISE dolazi sa vise ugradenih tema.
...
- Zele da RAILWISE odgovara izgledu njihovog terminala
...
RAILWISE podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
