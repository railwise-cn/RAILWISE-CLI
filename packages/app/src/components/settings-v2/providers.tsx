...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "railwise", key: "dialog.provider.railwise.note" },
  { match: (id: string) => id === "railwise-go", key: "dialog.provider.railwiseGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "railwise" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "railwise" || item.id === "railwise-go"}>
