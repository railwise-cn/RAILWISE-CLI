---
title: IDE
description: The RAILWISE extension for VS Code, Cursor, and other IDEs
---

RAILWISE integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `railwise` in the terminal to get started.
...
To install RAILWISE on VS Code and popular forks like Cursor, Windsurf, VSCodium:
...
Search for **RAILWISE** in the Extension Marketplace and click **Install**.
