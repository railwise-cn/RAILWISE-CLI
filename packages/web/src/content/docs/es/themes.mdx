...
Con RAILWISE puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, RAILWISE usa nuestro propio tema `railwise`.
...
RAILWISE viene con varios temas integrados.
...
- Quiere que RAILWISE coincida con la apariencia de su terminal
...
RAILWISE admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
