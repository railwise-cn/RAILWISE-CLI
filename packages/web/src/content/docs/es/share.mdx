---
title: Compartir
description: Comparte tus conversaciones YONSOON (甬算).
---

La función para compartir de YONSOON (甬算) te permite crear enlaces públicos a tus conversaciones de YONSOON (甬算), para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, YONSOON (甬算):
...
YONSOON (甬算) admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, YONSOON (甬算) usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `yonsoon.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de yonsoon en su organización.
