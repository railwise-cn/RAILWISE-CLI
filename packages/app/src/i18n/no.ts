...
export const dict = {
  ...
  "dialog.provider.yonsoon.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av YONSOON (甬算)",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i YONSOON (甬算).",
  ...
  "provider.connect.yonsoonZen.line1":
    "YONSOON (甬算) Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.yonsoonZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.yonsoonZen.visit.prefix": "Besøk ",
  "provider.connect.yonsoonZen.visit.link": "yonsoon.ai/zen",
  "provider.connect.yonsoonZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i YONSOON (甬算).",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i YONSOON (甬算).",
  ...
  "dialog.server.description": "Bytt hvilken YONSOON (甬算)-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av YONSOON (甬算) ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til YONSOON (甬算)-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at YONSOON (甬算) ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "YONSOON (甬算) inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør YONSOON (甬算)-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for YONSOON (甬算)",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan YONSOON (甬算) ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan YONSOON (甬算) er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når YONSOON (甬算) starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av YONSOON (甬算).",
