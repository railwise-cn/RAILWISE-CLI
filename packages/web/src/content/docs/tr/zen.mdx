...
RAILWISE Zen, railwise ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
RAILWISE Zen su anda beta asamasindadir.
:::

Zen, railwise'daki diger provider'lar gibi calisir. RAILWISE Zen'e giris yapar ve API anahtarinizi alirsiniz.
...
RAILWISE Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

RAILWISE Zen, railwise'daki diger provider'lar gibi calisir.

1. **<a href={console}>RAILWISE Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, RAILWISE Zen'i secin ve API anahtarinizi yapistirin
...
RAILWISE Zen'i su amaclarla olusturduk:
