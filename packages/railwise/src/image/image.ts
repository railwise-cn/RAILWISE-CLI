...
export class Service extends Context.Service<Service, Interface>()("@railwise/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __RAILWISE_PHOTON_WASM_PATH?: string }).__RAILWISE_PHOTON_WASM_PATH =
