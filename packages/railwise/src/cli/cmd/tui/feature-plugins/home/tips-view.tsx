import type { TuiPluginApi } from "@railwise/plugin/tui"
...
export function Tips(props: { api: TuiPluginApi; connected?: boolean }) {
  ...
  const shortcuts: Shortcuts = {
    ...
    statusView: useCommandShortcut("railwise.status"),
...
const TIPS: Tip[] = [
  ...
  ...(Flag.RAILWISE_EXPERIMENTAL_SESSION_SWITCHING
    ? ([
        (shortcuts) =>
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.railwise/commands/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.railwise/agents/{/highlight} for specialized AI personas",
  ...
  "Add {highlight}.ts{/highlight} files to {highlight}.railwise/plugins/{/highlight} for event hooks",
