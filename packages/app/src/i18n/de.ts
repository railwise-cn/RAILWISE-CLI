...
export const dict = {
  ...
  "dialog.provider.yonsoon.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von YONSOON (甬算)",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in YONSOON (甬算) zu nutzen.",
  ...
  "provider.connect.yonsoonZen.line1":
    "YONSOON (甬算) Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.yonsoonZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.yonsoonZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.yonsoonZen.visit.link": "yonsoon.ai/zen",
  "provider.connect.yonsoonZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in YONSOON (甬算) zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in YONSOON (甬算) zu nutzen.",
  ...
  "dialog.plugins.empty": "In yonsoon.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den YONSOON (甬算)-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von YONSOON (甬算) ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem YONSOON (甬算)-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (yonsoon.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: YONSOON (甬算) unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "YONSOON (甬算) enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "YONSOON (甬算) Desktop",
  ...
  "settings.desktop.wsl.description": "YONSOON (甬算)-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für YONSOON (甬算) ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie YONSOON (甬算) auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von YONSOON (甬算) anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von YONSOON (甬算) automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von YONSOON (甬算).",
