...
usa il formato `railwise/<model-id>`. Per esempio, per GPT 5.3 Codex, useresti
`railwise/gpt-5.3-codex` nella tua config.
...
- MiMo V2 Pro Free è disponibile su RAILWISE per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo V2 Omni Free è disponibile su RAILWISE per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
