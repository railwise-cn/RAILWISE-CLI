...
O [model id](/docs/config/#models) na sua configuração do RAILWISE usa o formato `railwise/<model-id>`. Por exemplo, para GPT 5.3 Codex, você usaria `railwise/gpt-5.3-codex` na sua configuração.
...
- MiMo V2 Pro Free está disponível no RAILWISE por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo V2 Omni Free está disponível no RAILWISE por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
