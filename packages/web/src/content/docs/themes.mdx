...
With RAILWISE you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, RAILWISE uses our own `railwise` theme.
...
RAILWISE comes with several built-in themes.
...
RAILWISE supports a flexible JSON-based theme system that allows users to create and customize themes easily.
