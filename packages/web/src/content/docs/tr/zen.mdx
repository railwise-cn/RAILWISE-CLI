...
RAILWISE yapılandırmanızdaki [model id](/docs/config/#models) `railwise/<model-id>` biçimini kullanır. Örneğin, GPT 5.3 Codex için yapılandırmanızda `railwise/gpt-5.3-codex` kullanırsınız.
...
- MiMo V2 Pro Free, sınırlı bir süre için RAILWISE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo V2 Omni Free, sınırlı bir süre için RAILWISE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
