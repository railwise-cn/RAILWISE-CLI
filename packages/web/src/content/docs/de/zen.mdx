...
Die [Model-ID](/docs/config/#models) in deiner RAILWISE-Konfiguration verwendet das Format `railwise/<model-id>`. Für GPT 5.3 Codex würdest du zum Beispiel `railwise/gpt-5.3-codex` in deiner Konfiguration verwenden.
...
- MiMo V2 Pro Free ist für begrenzte Zeit auf RAILWISE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo V2 Omni Free ist für begrenzte Zeit auf RAILWISE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
