export const dict = {
  ...
  "dialog.provider.yonsoon.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por YONSOON (甬算)",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en YONSOON (甬算).",
  ...
  "provider.connect.yonsoonZen.line1":
    "YONSOON (甬算) Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.yonsoonZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.yonsoonZen.visit.prefix": "Visita ",
  "provider.connect.yonsoonZen.visit.link": "yonsoon.ai/zen",
  "provider.connect.yonsoonZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en YONSOON (甬算).",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en YONSOON (甬算).",
  ...
  "dialog.plugins.empty": "Plugins configurados en yonsoon.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de YONSOON (甬算) se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de YONSOON (甬算) ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de YONSOON (甬算)",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (yonsoon.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, YONSOON (甬算) no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "YONSOON (甬算) incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor YONSOON (甬算) dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para YONSOON (甬算)",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve YONSOON (甬算) en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de YONSOON (甬算).",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia YONSOON (甬算)",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de YONSOON (甬算).",
