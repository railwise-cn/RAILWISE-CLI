...
export namespace Server {
    ...
    () =>
      ...
      app
        ...
        .use(
          cors({
            origin(input) {
              ...
              // *.railwise.ai (https only, adjust if needed)
              if (/^https:\/\/([a-z0-9-]+\.)*railwise.ai$/.test(input)) {
                return input
              }
        ...
        .use(async (c, next) => {
          ...
          const raw = c.req.query("directory") || c.req.header("x-railwise-directory") || process.cwd()
          const directory = (() => {
            try {
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Clean up and dispose the current RAILWISE instance, releasing all resources.",
        ...
        .get(
          ...
          describeRoute({
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the RAILWISE instance.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all available commands in the RAILWISE system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List agents",
            description: "Get a list of all available AI agents in the RAILWISE system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List skills",
            description: "Get a list of all available skills in the RAILWISE system.",
        ...
        .all("/*", async (c) => {
          ...
          const response = await proxy(`https://app.railwise.ai${path}`, {
            ...c.req,
            headers: {
              ...c.req.raw.headers,
              host: "app.railwise.ai",
            },
          })
  ...
  export function listen(opts: {
    ...
    if (!server) {
      ...
      throw new Error(`Failed to start server on port ${opts.port}${detail ? ` (${detail})` : ""}`)
    }
