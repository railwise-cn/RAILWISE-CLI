---
title: Zen
description: yonsoon ekibinin sundugu secili model listesi.
---
...
YONSOON (甬算) Zen, yonsoon ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
YONSOON (甬算) Zen su anda beta asamasindadir.
:::

Zen, yonsoon'daki diger provider'lar gibi calisir. YONSOON (甬算) Zen'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; yonsoon kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
yonsoon ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
YONSOON (甬算) Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

YONSOON (甬算) Zen, yonsoon'daki diger provider'lar gibi calisir.

1. **<a href={console}>YONSOON (甬算) Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, YONSOON (甬算) Zen'i secin ve API anahtarinizi yapistirin
...
yonsoon config'inizdeki [model id](/docs/config/#models), `yonsoon/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `yonsoon/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin yonsoon'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin yonsoon'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin yonsoon'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin yonsoon'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
YONSOON (甬算) Zen'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve yonsoon'da diger provider'lari her zaman acik tutmak
