...
| Qwen3.6 Plus          | qwen3.6-plus          | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/alibaba`           |
| Qwen3.5 Plus          | qwen3.5-plus          | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/alibaba`           |
...
| MiMo V2 Pro Free      | mimo-v2-pro-free      | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiMo V2 Omni Free     | mimo-v2-omni-free     | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free | nemotron-3-super-free | `https://railwise.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Le [model id](/docs/config/#models) dans votre configuration RAILWISE utilise le format `railwise/<model-id>`. Par exemple, pour GPT 5.3 Codex, vous utiliseriez `railwise/gpt-5.3-codex` dans votre configuration.
...
- MiMo V2 Pro Free est disponible sur RAILWISE pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo V2 Omni Free est disponible sur RAILWISE pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
