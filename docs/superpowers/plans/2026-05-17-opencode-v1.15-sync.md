...
> Archived note: this plan predates the Desktop split. Historical Desktop sync and verification paths now live in the standalone `railwise-desktop-app` repository.
