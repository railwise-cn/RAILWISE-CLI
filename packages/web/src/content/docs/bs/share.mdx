---
title: Dijeljenje
description: Dijelite YONSOON (甬算) razgovore javnim linkovima.
---

YONSOON (甬算) opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, YONSOON (甬算):
...
YONSOON (甬算) podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, YONSOON (甬算) koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `yonsoon.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju yonsoon u organizaciji.
