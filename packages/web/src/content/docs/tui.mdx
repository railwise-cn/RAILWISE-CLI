---
title: TUI
description: Using the YONSOON (甬算) terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

YONSOON (甬算) provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running YONSOON (甬算) starts the TUI for the current directory.
...
When using the YONSOON (甬算) TUI, you can type `/` followed by a command name to quickly execute actions. For example:
