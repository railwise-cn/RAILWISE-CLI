---
title: Compartir
description: Comparte tus conversaciones RAILWISE.
---

La función para compartir de RAILWISE te permite crear enlaces públicos a tus conversaciones de RAILWISE, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, RAILWISE:
...
RAILWISE admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, RAILWISE usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
